...
from virchow.db.document import fetch_document_ids_by_links
from virchow.db.document import filter_existing_document_ids
...
from virchow.tools.models import OpenURLToolOverrideKwargs
from virchow.tools.models import ToolCallException
from virchow.tools.models import ToolResponse
from virchow.tools.tool_implementations.open_url.models import WebContentProvider
from virchow.tools.tool_implementations.open_url.url_normalization import (
    _default_url_normalizer,
)
from virchow.tools.tool_implementations.open_url.url_normalization import normalize_url
from virchow.tools.tool_implementations.open_url.utils import (
    filter_web_contents_with_no_title_or_content,
)
from virchow.tools.tool_implementations.web_search.providers import (
    get_default_content_provider,
)
from virchow.tools.tool_implementations.web_search.utils import (
    inference_section_from_internet_page_scrape,
)
from virchow.tools.tool_implementations.web_search.utils import MAX_CHARS_PER_URL
...
from virchow.utils.url import normalize_url as normalize_web_content_url
    ...
    def __init__(
        ...
        Args:
            ...
            content_provider: Optional content provider. If not provided,
                ...
                to the built-in Virchow web crawler.
        """
        ...
        if content_provider is not None:
            ...
            if provider is None:
                raise RuntimeError(
                    ...
                    "built-in Virchow web crawler can be initialized."
                )
