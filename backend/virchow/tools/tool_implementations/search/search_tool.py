...
from virchow.configs.chat_configs import MAX_CHUNKS_FED_TO_CHAT
from virchow.context.search.models import BaseFilters
from virchow.context.search.models import ChunkIndexRequest
from virchow.context.search.models import ChunkSearchRequest
...
from virchow.context.search.pipeline import merge_individual_chunks
from virchow.context.search.pipeline import search_pipeline
from virchow.context.search.preprocessing.access_filters import (
    build_access_filters_for_user,
)
from virchow.context.search.utils import convert_inference_sections_to_search_docs
from virchow.db.connector import check_connectors_exist
from virchow.db.connector import check_federated_connectors_exist
...
from virchow.secondary_llm_flows.document_filter import select_chunks_for_relevance
from virchow.secondary_llm_flows.document_filter import select_sections_for_expansion
from virchow.secondary_llm_flows.query_expansion import keyword_query_expansion
from virchow.secondary_llm_flows.query_expansion import semantic_query_rephrase
...
from virchow.tools.models import SearchToolOverrideKwargs
from virchow.tools.models import ToolCallException
from virchow.tools.models import ToolResponse
from virchow.tools.tool_implementations.search.constants import (
...
from virchow.tools.tool_implementations.search.constants import ORIGINAL_QUERY_WEIGHT
from virchow.tools.tool_implementations.search.search_utils import (
...
from virchow.tools.tool_implementations.utils import (
...
class SearchTool(Tool[SearchToolOverrideKwargs]):
    ...
    def is_available(cls, db_session: Session) -> bool:
        ...
        from virchow.db.connector import check_user_files_exist
