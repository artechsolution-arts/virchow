...
from virchow.configs.app_configs import CODE_INTERPRETER_DEFAULT_TIMEOUT_MS
from virchow.configs.app_configs import CODE_INTERPRETER_MAX_OUTPUT_LENGTH
from virchow.configs.constants import FileOrigin
from virchow.db.code_interpreter import fetch_code_interpreter_server
from virchow.file_store.utils import build_full_frontend_file_url
...
from virchow.tools.models import LlmPythonExecutionResult
from virchow.tools.models import PythonExecutionFile
...
from virchow.tools.tool_implementations.python.code_interpreter_client import (
    CodeInterpreterClient,
)
from virchow.tools.tool_implementations.python.code_interpreter_client import FileInput
from virchow.tools.tool_implementations.python.code_interpreter_client import (
    StreamErrorEvent,
)
from virchow.tools.tool_implementations.python.code_interpreter_client import (
            ...
            try:
                ...
                for workspace_file in result_event.files:
                    ...
                    try:
                        ...
                        # Save to Virchow file store
                        virchow_file_id = file_store.save_file(
                        ...
                        generated_files.append(
                            PythonExecutionFile(
                                filename=filename,
                                file_link=build_full_frontend_file_url(virchow_file_id),
                            )
                        )
                        generated_file_ids.append(virchow_file_id)
