...
from virchow.db.models import InternetSearchProvider
from virchow.db.web_search import fetch_active_web_content_provider
from virchow.db.web_search import fetch_active_web_search_provider
from virchow.tools.tool_implementations.open_url.firecrawl import FirecrawlClient
from virchow.tools.tool_implementations.open_url.models import (
    WebContentProvider,
)
from virchow.tools.tool_implementations.open_url.virchow_web_crawler import (
    DEFAULT_MAX_HTML_SIZE_BYTES,
)
from virchow.tools.tool_implementations.open_url.virchow_web_crawler import (
    DEFAULT_MAX_PDF_SIZE_BYTES,
)
from virchow.tools.tool_implementations.open_url.virchow_web_crawler import VirchowWebCrawler
from virchow.tools.tool_implementations.web_search.clients.brave_client import (
    BraveClient,
)
from virchow.tools.tool_implementations.web_search.clients.exa_client import (
    ExaClient,
)
from virchow.tools.tool_implementations.web_search.clients.google_pse_client import (
    GooglePSEClient,
)
from virchow.tools.tool_implementations.web_search.clients.searxng_client import (
    SearXNGClient,
)
from virchow.tools.tool_implementations.web_search.clients.serper_client import (
    SerperClient,
)
from virchow.tools.tool_implementations.web_search.models import DEFAULT_MAX_RESULTS
from virchow.tools.tool_implementations.web_search.models import WebContentProviderConfig
from virchow.tools.tool_implementations.web_search.models import WebSearchProvider
...
def build_content_provider_from_config(
    *,
    ...
    if provider_type == WebContentProviderType.VIRCHOW_WEB_CRAWLER:
        if config.timeout_seconds is not None:
            return VirchowWebCrawler(
