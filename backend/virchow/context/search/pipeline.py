...
from virchow.context.search.retrieval.search_runner import search_chunks
...
from virchow.natural_language_processing.english_stopwords import strip_stopwords
from virchow.natural_language_processing.search_nlp_models import EmbeddingModel
from virchow.secondary_llm_flows.source_filter import extract_source_filter
from virchow.secondary_llm_flows.time_filter import extract_time_filter
from virchow.utils.logger import setup_logger
from virchow.utils.threadpool_concurrency import FunctionCall
from virchow.utils.threadpool_concurrency import run_functions_in_parallel
...
def search_pipeline(
    ...
    censored_chunks: list[InferenceChunk] = fetch_ee_implementation_or_noop(
        "virchow.external_permissions.post_query_censoring",
