...
from virchow.db.models import Notification as NotificationDBModel
...
class UserSettings(Settings):
    ...
    # Feature flag for Virchow Craft (Build Mode) - used for server-side redirects
    virchow_craft_enabled: bool = False
