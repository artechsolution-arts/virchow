...
from virchow.context.search.models import SearchSettingsCreationRequest
...
from virchow.db.llm import update_default_contextual_model
from virchow.db.llm import update_no_default_contextual_rag_provider
from virchow.db.models import IndexModelStatus
from virchow.db.models import User
from virchow.db.search_settings import create_search_settings
from virchow.db.search_settings import delete_search_settings
from virchow.db.search_settings import get_current_search_settings
from virchow.db.search_settings import get_embedding_provider_from_provider_type
...
from virchow.db.search_settings import update_search_settings_status
...
from virchow.file_processing.unstructured import delete_unstructured_api_key
from virchow.file_processing.unstructured import get_unstructured_api_key
from virchow.file_processing.unstructured import update_unstructured_api_key
from virchow.natural_language_processing.search_nlp_models import clean_model_name
from virchow.server.manage.embedding.models import SearchSettingsDeleteRequest
from virchow.server.manage.models import FullModelVersionResponse
from virchow.server.models import IdReturn
...
def set_new_search_settings(
    ...
    if MULTI_TENANT and search_settings_new.enable_contextual_rag:
        raise HTTPException(
            ...
            detail="Contextual RAG disabled in Virchow Cloud",
        )
