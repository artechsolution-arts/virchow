...
from virchow.configs.app_configs import GENERATIVE_MODEL_ACCESS_CHECK_FREQ
from virchow.configs.constants import DocumentSource
from virchow.configs.constants import KV_GEN_AI_KEY_CHECK_TIME
...
from virchow.db.connector_credential_pair import get_connector_credential_pair_for_user
...
from virchow.db.feedback import fetch_docs_ranked_by_boost_for_user
from virchow.db.feedback import update_document_boost_for_user
from virchow.db.feedback import update_document_hidden_for_user
from virchow.db.index_attempt import cancel_indexing_attempts_for_ccpair
...
from virchow.server.manage.models import BoostDoc
from virchow.server.manage.models import BoostUpdateRequest
from virchow.server.manage.models import HiddenUpdateRequest
...
def create_deletion_attempt_for_connector_id(
    ...
    client_app.send_task(
        VirchowCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
