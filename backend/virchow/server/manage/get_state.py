...
from virchow.auth.users import user_needs_to_be_verified
from virchow.configs.app_configs import AUTH_TYPE
from virchow.configs.app_configs import OAUTH_ENABLED
from virchow.configs.app_configs import PASSWORD_MIN_LENGTH
from virchow.configs.constants import AuthType
from virchow.configs.constants import DEV_VERSION_PATTERN
from virchow.configs.constants import PUBLIC_API_TAGS
from virchow.configs.constants import STABLE_VERSION_PATTERN
from virchow.db.auth import get_user_count
from virchow.server.manage.models import AllVersions
from virchow.server.manage.models import AuthTypeResponse
from virchow.server.manage.models import ContainerVersions
from virchow.server.manage.models import VersionResponse
...
def get_versions() -> AllVersions:
    """
    Fetches the latest stable and beta versions of Virchow Docker images.
    ...
    """
    # Fetch the latest tags from DockerHub for each Virchow component
    dockerhub_repos = [
        "virchowdotapp/virchow-model-server",
        "virchowdotapp/virchow-backend",
        "virchowdotapp/virchow-web-server",
    ]
