...
from virchow.db.enums import LLMModelFlowType
from virchow.db.llm import can_user_access_llm_provider
from virchow.db.llm import fetch_default_llm_model
from virchow.db.llm import fetch_default_vision_model
from virchow.db.llm import fetch_existing_llm_provider
from virchow.db.llm import fetch_existing_llm_provider_by_id
from virchow.db.llm import fetch_existing_llm_providers
from virchow.db.llm import fetch_existing_models
from virchow.db.llm import fetch_persona_with_groups
from virchow.db.llm import fetch_user_group_ids
from virchow.db.llm import remove_llm_provider
from virchow.db.llm import sync_model_configurations
from virchow.db.llm import update_default_provider
from virchow.db.llm import update_default_vision_provider
from virchow.db.llm import upsert_llm_provider
from virchow.db.llm import validate_persona_ids_exist
from virchow.db.models import User
from virchow.db.persona import user_can_access_persona
...
from virchow.llm.factory import get_llm
from virchow.llm.factory import get_max_input_tokens_from_llm_provider
from virchow.llm.utils import get_bedrock_token_limit
from virchow.llm.utils import get_llm_contextual_cost
from virchow.llm.utils import test_llm
from virchow.llm.well_known_providers.auto_update_service import (
    fetch_llm_recommendations_from_github,
)
from virchow.llm.well_known_providers.constants import LM_STUDIO_API_KEY_CONFIG_KEY
from virchow.llm.well_known_providers.llm_provider_options import (
    fetch_available_well_known_llms,
)
from virchow.llm.well_known_providers.llm_provider_options import (
    WellKnownLLMProviderDescriptor,
)
from virchow.server.manage.llm.models import BedrockFinalModelResponse
from virchow.server.manage.llm.models import BedrockModelsRequest
from virchow.server.manage.llm.models import DefaultModel
from virchow.server.manage.llm.models import LitellmFinalModelResponse
from virchow.server.manage.llm.models import LitellmModelDetails
from virchow.server.manage.llm.models import LitellmModelsRequest
from virchow.server.manage.llm.models import LLMCost
from virchow.server.manage.llm.models import LLMProviderDescriptor
from virchow.server.manage.llm.models import LLMProviderResponse
from virchow.server.manage.llm.models import LLMProviderUpsertRequest
from virchow.server.manage.llm.models import LLMProviderView
from virchow.server.manage.llm.models import LMStudioFinalModelResponse
from virchow.server.manage.llm.models import LMStudioModelsRequest
from virchow.server.manage.llm.models import ModelConfigurationUpsertRequest
from virchow.server.manage.llm.models import OllamaFinalModelResponse
from virchow.server.manage.llm.models import OllamaModelDetails
from virchow.server.manage.llm.models import OllamaModelsRequest
from virchow.server.manage.llm.models import OpenRouterFinalModelResponse
from virchow.server.manage.llm.models import OpenRouterModelDetails
from virchow.server.manage.llm.models import OpenRouterModelsRequest
from virchow.server.manage.llm.models import SyncModelEntry
from virchow.server.manage.llm.models import TestLLMRequest
from virchow.server.manage.llm.utils import generate_bedrock_display_name
from virchow.server.manage.llm.utils import generate_ollama_display_name
from virchow.server.manage.llm.utils import infer_vision_support
from virchow.server.manage.llm.utils import is_embedding_model
from virchow.server.manage.llm.utils import is_reasoning_model
from virchow.server.manage.llm.utils import is_valid_bedrock_model
from virchow.server.manage.llm.utils import ModelMetadata
from virchow.server.manage.llm.utils import strip_openrouter_vendor_prefix
from virchow.utils.encryption import mask_string as mask_with_ellipsis
...
def _validate_llm_provider_change(
    ...
    Raises:
        VirchowError: If api_base or custom_config changed without changing API key
    """
...
def fetch_llm_provider_options(
    ...
    raise VirchowError(VirchowErrorCode.NOT_FOUND, f"Provider {provider_name} not found")
...
def test_llm_configuration(
    ...
    if error_msg:
        raise VirchowError(VirchowErrorCode.VALIDATION_ERROR, error_msg)
...
def test_default_provider(
    ...
    try:
        ...
        raise VirchowError(VirchowErrorCode.VALIDATION_ERROR, "No LLM Provider setup")

    error = test_llm(llm)
    if error:
        raise VirchowError(VirchowErrorCode.VALIDATION_ERROR, str(error))
...
def put_llm_provider(
    ...
    if found_provider is not None and found_provider is not existing_provider:
        raise VirchowError(
            VirchowErrorCode.DUPLICATE_RESOURCE,
    ...
    try:
        ...
        if transitioning_to_auto_mode:
            from virchow.db.llm import sync_auto_mode_models
        ...
        raise VirchowError(VirchowErrorCode.VALIDATION_ERROR, str(e))
...
def delete_llm_provider(
    ...
    try:
        ...
        raise VirchowError(VirchowErrorCode.NOT_FOUND, str(e))
...
def get_valid_model_names_for_persona(
    ...
    all_providers = fetch_existing_llm_providers(
        db_session, [LLMModelFlowType.CHAT]
    )
...
def get_bedrock_available_models(
    ...
    try:
        ...
        try:
            ...
            raise VirchowError(
                VirchowErrorCode.CREDENTIAL_INVALID,
        ...
        raise VirchowError(
            VirchowErrorCode.INTERNAL_ERROR,
...
def _get_openrouter_models_response(api_base: str, api_key: str) -> dict:
    ...
    headers = {
        ...
        "HTTP-Referer": "https://virchow.app",
        "X-Title": "Virchow",
    }
    try:
