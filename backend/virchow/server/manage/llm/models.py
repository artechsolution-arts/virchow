...
from virchow.llm.utils import litellm_thinks_model_supports_image_input
from virchow.llm.utils import model_is_reasoning_model
from virchow.server.manage.llm.utils import DYNAMIC_LLM_PROVIDERS
from virchow.server.manage.llm.utils import extract_vendor_from_model_name
from virchow.server.manage.llm.utils import filter_model_configurations
from virchow.server.manage.llm.utils import is_reasoning_model


if TYPE_CHECKING:
    from virchow.db.models import (
...
class ModelConfigurationView(BaseModel):
    ...
    def from_model(
        ...
        from virchow.llm.model_name_parser import parse_litellm_model_name
