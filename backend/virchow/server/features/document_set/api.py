...
from virchow.db.document_set import check_document_sets_are_public
from virchow.db.document_set import delete_document_set as db_delete_document_set
from virchow.db.document_set import fetch_all_document_sets_for_user
from virchow.db.document_set import get_document_set_by_id
from virchow.db.document_set import insert_document_set
from virchow.db.document_set import mark_document_set_as_to_be_deleted
from virchow.db.document_set import update_document_set
from virchow.db.engine.sql_engine import get_session
from virchow.db.models import User
from virchow.server.features.document_set.models import CheckDocSetPublicRequest
from virchow.server.features.document_set.models import CheckDocSetPublicResponse
from virchow.server.features.document_set.models import DocumentSetCreationRequest
from virchow.server.features.document_set.models import DocumentSetSummary
from virchow.server.features.document_set.models import DocumentSetUpdateRequest
...
def create_document_set(
    ...
    if not DISABLE_VECTOR_DB:
        client_app.send_task(
            VirchowCeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
