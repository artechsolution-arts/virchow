...
# Example: /var/virchow/file-system or /app/file-system
...
SANDBOX_BASE_PATH = os.environ.get("SANDBOX_BASE_PATH", "/tmp/virchow-sandboxes")
...
SANDBOX_NAMESPACE = os.environ.get("SANDBOX_NAMESPACE", "virchow-sandboxes")
...
SANDBOX_CONTAINER_IMAGE = os.environ.get(
    "SANDBOX_CONTAINER_IMAGE", "virchowdotapp/sandbox:v0.1.5"
)
...
SANDBOX_S3_BUCKET = os.environ.get("SANDBOX_S3_BUCKET", "virchow-sandbox-files")
