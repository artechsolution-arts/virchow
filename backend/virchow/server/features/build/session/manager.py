...
from virchow.db.enums import SandboxStatus
from virchow.db.llm import fetch_default_llm_model
from virchow.db.models import BuildMessage
from virchow.db.models import BuildSession
from virchow.db.models import User
from virchow.db.users import fetch_user_by_id
from virchow.llm.factory import get_default_llm
from virchow.llm.models import LanguageModelInput
from virchow.llm.models import ReasoningEffort
from virchow.llm.models import SystemMessage
from virchow.llm.models import UserMessage
from virchow.llm.utils import llm_response_to_string
from virchow.server.features.build.api.models import DirectoryListing
from virchow.server.features.build.api.models import FileSystemEntry
from virchow.server.features.build.api.packet_logger import get_packet_logger
from virchow.server.features.build.api.packet_logger import log_separator
from virchow.server.features.build.api.packets import BuildPacket
from virchow.server.features.build.api.packets import ErrorPacket
from virchow.server.features.build.api.rate_limit import get_user_rate_limit_status
from virchow.server.features.build.configs import MAX_TOTAL_UPLOAD_SIZE_BYTES
from virchow.server.features.build.configs import MAX_UPLOAD_FILES_PER_SESSION
from virchow.server.features.build.configs import PERSISTENT_DOCUMENT_STORAGE_PATH
from virchow.server.features.build.configs import SANDBOX_BACKEND
from virchow.server.features.build.configs import SandboxBackend
from virchow.server.features.build.db.build_session import allocate_nextjs_port
from virchow.server.features.build.db.build_session import create_build_session__no_commit
from virchow.server.features.build.db.build_session import create_message
from virchow.server.features.build.db.build_session import delete_build_session__no_commit
from virchow.server.features.build.db.build_session import (
    fetch_llm_provider_by_type_for_build_mode,
)
from virchow.server.features.build.db.build_session import get_build_session
from virchow.server.features.build.db.build_session import get_empty_session_for_user
from virchow.server.features.build.db.build_session import get_session_messages
from virchow.server.features.build.db.build_session import get_user_build_sessions
from virchow.server.features.build.db.build_session import update_session_activity
from virchow.server.features.build.db.build_session import upsert_agent_plan
from virchow.server.features.build.db.sandbox import create_sandbox__no_commit
from virchow.server.features.build.db.sandbox import get_running_sandbox_count_by_tenant
from virchow.server.features.build.db.sandbox import get_sandbox_by_session_id
from virchow.server.features.build.db.sandbox import get_sandbox_by_user_id
from virchow.server.features.build.db.sandbox import get_snapshots_for_session
from virchow.server.features.build.db.sandbox import update_sandbox_heartbeat
from virchow.server.features.build.db.sandbox import update_sandbox_status__no_commit
from virchow.server.features.build.sandbox import get_sandbox_manager
from virchow.server.features.build.sandbox.kubernetes.internal.acp_exec_client import (
    SSEKeepalive,
)
from virchow.server.features.build.sandbox.models import LLMProviderConfig
from virchow.server.features.build.sandbox.tasks.tasks import (
    _get_disabled_user_library_paths,
)
from virchow.server.features.build.session.prompts import BUILD_NAMING_SYSTEM_PROMPT
from virchow.server.features.build.session.prompts import BUILD_NAMING_USER_PROMPT
from virchow.server.features.build.session.prompts import (
    FOLLOWUP_SUGGESTIONS_SYSTEM_PROMPT,
)
from virchow.server.features.build.session.prompts import FOLLOWUP_SUGGESTIONS_USER_PROMPT
...
class SessionManager:
    ...
    def create_session__no_commit(
        ...
        if MULTI_TENANT:
            from virchow.server.features.build.configs import (
        ...
        if PERSISTENT_DOCUMENT_STORAGE_PATH:
            ...
            user_file_system_path = "/tmp/virchow-files"
    ...
    def delete_session(
        ...
        if snapshots:
            ...
            from virchow.server.features.build.sandbox.manager.snapshot_manager import (
                SnapshotManager,
            )
    ...
    def _check_nextjs_ready(self, sandbox_id: UUID, port: int) -> bool:
        ...
        from virchow.server.features.build.sandbox.base import get_sandbox_manager
    ...
    def terminate_user_sandbox(self, user_id: UUID) -> bool:
        ...
        """
        from virchow.server.features.build.db.sandbox import (
            update_sandbox_status__no_commit,
        )
