...
from virchow.server.features.build.configs import ACP_MESSAGE_TIMEOUT
from virchow.server.features.build.configs import SSE_KEEPALIVE_INTERVAL
...
# Default client info
DEFAULT_CLIENT_INFO = {
    "name": "virchow-sandbox-k8s-exec",
    "title": "Virchow Sandbox Agent Client (K8s Exec)",
    "version": "1.0.0",
}
