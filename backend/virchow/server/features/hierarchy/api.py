...
from virchow.access.hierarchy_access import get_user_external_group_ids
...
from virchow.db.document import get_accessible_documents_for_hierarchy_node_paginated
from virchow.db.engine.sql_engine import get_session
from virchow.db.hierarchy import get_accessible_hierarchy_nodes_for_source
from virchow.db.models import User
from virchow.db.opensearch_migration import get_opensearch_retrieval_state
from virchow.server.features.hierarchy.constants import DOCUMENT_PAGE_SIZE
from virchow.server.features.hierarchy.constants import HIERARCHY_NODE_DOCUMENTS_PATH
from virchow.server.features.hierarchy.constants import HIERARCHY_NODES_LIST_PATH
from virchow.server.features.hierarchy.constants import HIERARCHY_NODES_PREFIX
from virchow.server.features.hierarchy.models import DocumentPageCursor
from virchow.server.features.hierarchy.models import DocumentSortDirection
from virchow.server.features.hierarchy.models import DocumentSortField
from virchow.server.features.hierarchy.models import DocumentSummary
from virchow.server.features.hierarchy.models import HierarchyNodeDocumentsRequest
from virchow.server.features.hierarchy.models import HierarchyNodeDocumentsResponse
from virchow.server.features.hierarchy.models import HierarchyNodesResponse
from virchow.server.features.hierarchy.models import HierarchyNodeSummary
...
def _require_opensearch(db_session: Session) -> None:
    if not ENABLE_OPENSEARCH_INDEXING_FOR_VIRCHOW:
        raise HTTPException(
            status_code=403,
