...
from virchow.chat.chat_processing_checker import is_chat_session_processing
from virchow.chat.chat_state import ChatStateContainer
from virchow.chat.chat_utils import convert_chat_history_basic
...
from virchow.chat.chat_utils import extract_headers
from virchow.chat.models import ChatFullResponse
from virchow.chat.models import CreateChatSessionID
from virchow.chat.process_message import gather_stream_full
from virchow.chat.process_message import handle_stream_message_objects
from virchow.chat.prompt_utils import get_default_base_system_prompt
from virchow.chat.stop_signal_checker import set_fence
from virchow.configs.app_configs import WEB_DOMAIN
from virchow.configs.chat_configs import HARD_DELETE_CHATS
...
from virchow.configs.model_configs import LITELLM_PASS_THROUGH_HEADERS
from virchow.db.chat import delete_all_chat_sessions_for_user
from virchow.db.chat import delete_chat_session
from virchow.db.chat import get_chat_message
from virchow.db.chat import get_chat_messages_by_session
from virchow.db.chat import get_chat_session_by_id
from virchow.db.chat import get_chat_sessions_by_user
from virchow.db.chat import set_as_latest_chat_message
from virchow.db.chat import translate_db_message_to_chat_message_detail
from virchow.db.chat import update_chat_session
from virchow.db.chat_search import search_chat_sessions
...
from virchow.db.feedback import create_chat_message_feedback
from virchow.db.feedback import remove_chat_message_feedback
from virchow.db.models import ChatSessionSharedStatus
from virchow.db.models import Persona
from virchow.db.models import User
from virchow.db.persona import get_persona_by_id
from virchow.db.usage import increment_usage
from virchow.db.usage import UsageType
from virchow.db.user_file import get_file_id_by_user_file_id
from virchow.file_store.file_store import get_default_file_store
from virchow.llm.constants import LlmProviderNames
from virchow.llm.factory import get_default_llm
from virchow.llm.factory import get_llm_for_persona
from virchow.llm.factory import get_llm_token_counter
from virchow.secondary_llm_flows.chat_session_naming import generate_chat_session_name
from virchow.server.api_key_usage import check_api_key_usage
from virchow.server.query_and_chat.models import ChatFeedbackRequest
from virchow.server.query_and_chat.models import ChatMessageIdentifier
from virchow.server.query_and_chat.models import ChatRenameRequest
from virchow.server.query_and_chat.models import ChatSearchResponse
from virchow.server.query_and_chat.models import ChatSessionCreationRequest
from virchow.server.query_and_chat.models import ChatSessionDetailResponse
from virchow.server.query_and_chat.models import ChatSessionDetails
from virchow.server.query_and_chat.models import ChatSessionGroup
from virchow.server.query_and_chat.models import ChatSessionsResponse
from virchow.server.query_and_chat.models import ChatSessionSummary
from virchow.server.query_and_chat.models import ChatSessionUpdateRequest
from virchow.server.query_and_chat.models import MessageOrigin
from virchow.server.query_and_chat.models import RenameChatSessionResponse
from virchow.server.query_and_chat.models import SendMessageRequest
from virchow.server.query_and_chat.models import UpdateChatSessionTemperatureRequest
from virchow.server.query_and_chat.models import UpdateChatSessionThreadRequest
from virchow.server.query_and_chat.session_loading import (
    translate_assistant_message_to_packets,
)
from virchow.server.query_and_chat.streaming_models import Packet
from virchow.server.query_and_chat.token_limit import check_token_rate_limits
...
from virchow.server.usage_limits import is_usage_limits_enabled
from virchow.server.utils import get_json_line
from virchow.tracing.framework.create import ensure_trace
from virchow.utils.headers import get_custom_tool_additional_request_headers
...
def handle_send_chat_message(
    ...
    # Streaming path, normal Virchow UI behavior
...
#         page_size=page_size,
#         include_deleted=False,
#         include_virchowbot_flows=False,
#     )
# 
