...
from virchow.configs.app_configs import CACHE_BACKEND


def _build_redis_backend(tenant_id: str) -> CacheBackend:
    from virchow.cache.redis_backend import RedisCacheBackend
    from virchow.redis.redis_pool import redis_pool
