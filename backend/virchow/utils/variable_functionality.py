...
from virchow.configs.app_configs import API_SERVER_HOST
from virchow.configs.app_configs import API_SERVER_PROTOCOL
from virchow.configs.app_configs import API_SERVER_URL_OVERRIDE_FOR_HTTP_REQUESTS
...
def fetch_versioned_implementation(module: str, attribute: str) -> Any:
    ...
    try:
        ...
        if is_ee:
            if "ee.virchow" not in str(e):
                # If it's a non Virchow related import failure, this is likely because
