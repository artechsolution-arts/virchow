...
from virchow.configs.app_configs import DISABLE_TELEMETRY
from virchow.configs.app_configs import ENTERPRISE_EDITION_ENABLED
from virchow.configs.constants import KV_CUSTOMER_UUID_KEY
from virchow.configs.constants import KV_INSTANCE_DOMAIN_KEY
...
_DANSWER_TELEMETRY_ENDPOINT = "https://telemetry.virchow.app/anonymous_telemetry"
...
def optional_telemetry(
    ...
    try:
        ...
        # Should never interfere with normal functions of Virchow
        pass
...
def mt_cloud_telemetry(
    ...
    # This is only for Virchow MT Cloud, this code should also never be hit, no reason for any orgs to
    # be running the Multi Tenant version of Virchow.
    fetch_versioned_implementation_with_fallback(
        module="virchow.utils.telemetry",
