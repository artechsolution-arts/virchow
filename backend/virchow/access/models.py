...
from virchow.access.utils import prefix_user_group
...
class ExternalAccess:
    ...
    # Whether the document is public in the external system or Virchow
    is_public: bool
...
class DocumentAccess(ExternalAccess):
    # User emails for Virchow users, None indicates admin
