...
from virchow.configs.app_configs import AWS_REGION_NAME
from virchow.configs.app_configs import S3_AWS_ACCESS_KEY_ID
from virchow.configs.app_configs import S3_AWS_SECRET_ACCESS_KEY
from virchow.configs.app_configs import S3_ENDPOINT_URL
from virchow.configs.app_configs import S3_FILE_STORE_BUCKET_NAME
from virchow.configs.app_configs import S3_FILE_STORE_PREFIX
from virchow.configs.app_configs import S3_GENERATE_LOCAL_CHECKSUM
from virchow.configs.app_configs import S3_VERIFY_SSL
from virchow.configs.constants import FileOrigin
from virchow.db.engine.sql_engine import get_session_with_current_tenant
from virchow.db.engine.sql_engine import get_session_with_current_tenant_if_none
from virchow.db.file_record import delete_filerecord_by_file_id
from virchow.db.file_record import get_filerecord_by_file_id
from virchow.db.file_record import get_filerecord_by_file_id_optional
from virchow.db.file_record import get_filerecord_by_prefix
from virchow.db.file_record import upsert_filerecord
from virchow.db.models import FileRecord
from virchow.db.models import FileRecord as FileStoreModel
from virchow.file_store.s3_key_utils import generate_s3_key
...
class S3BackedFileStore(FileStore):
    ...
    def __init__(
        ...
        self._s3_prefix = s3_prefix or "virchow-files"
...
def get_default_file_store() -> FileStore:
    ...
    """
    from virchow.configs.app_configs import FILE_STORE_BACKEND
    from virchow.configs.constants import FileStoreType

    if FileStoreType(FILE_STORE_BACKEND) == FileStoreType.POSTGRES:
        from virchow.file_store.postgres_file_store import PostgresBackedFileStore
