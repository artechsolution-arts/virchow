...
from virchow.configs.app_configs import WEB_CONNECTOR_OAUTH_CLIENT_ID
from virchow.configs.app_configs import WEB_CONNECTOR_OAUTH_CLIENT_SECRET
from virchow.configs.app_configs import WEB_CONNECTOR_OAUTH_TOKEN_URL
from virchow.configs.app_configs import WEB_CONNECTOR_VALIDATE_URLS
...
from virchow.file_processing.html_utils import web_html_cleanup
from virchow.utils.logger import setup_logger
from virchow.utils.sitemap import list_pages_for_site
from virchow.utils.web_content import extract_pdf_text
from virchow.utils.web_content import is_pdf_resource
...
if __name__ == "__main__":
    connector = WebConnector("https://docs.virchow.app/")
