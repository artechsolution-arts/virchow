...
SCOPE_DOC_URL = "https://docs.virchow.app/admins/connectors/official/google_drive/overview"
VIRCHOW_SCOPE_INSTRUCTIONS = (
    "You have upgraded Virchow without updating the Google Auth scopes. "
