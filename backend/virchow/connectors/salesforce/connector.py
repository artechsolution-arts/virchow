...
from virchow.connectors.interfaces import GenerateDocumentsOutput
...
from virchow.connectors.salesforce.doc_conversion import convert_sf_object_to_doc
from virchow.connectors.salesforce.doc_conversion import convert_sf_query_result_to_doc
from virchow.connectors.salesforce.doc_conversion import ID_PREFIX
from virchow.connectors.salesforce.virchow_salesforce import VirchowSalesforce
from virchow.connectors.salesforce.salesforce_calls import fetch_all_csvs_in_parallel
from virchow.connectors.salesforce.sqlite_functions import VirchowSalesforceSQLite
from virchow.connectors.salesforce.utils import ACCOUNT_OBJECT_TYPE
from virchow.connectors.salesforce.utils import ID_FIELD
from virchow.connectors.salesforce.utils import MODIFIED_FIELD
from virchow.connectors.salesforce.utils import NAME_FIELD
from virchow.connectors.salesforce.utils import USER_OBJECT_TYPE
...
class SalesforceConnector(LoadConnector, PollConnector, SlimConnectorWithPermSync):
    ...
    def __init__(
        ...
        self._sf_client: VirchowSalesforce | None = None
    ...
    def load_credentials(
        ...
        self._sf_client = VirchowSalesforce(
    ...
    @property
    def sf_client(self) -> VirchowSalesforce:
    ...
    def _load_csvs_to_db(
        csv_directory: str, remove_ids: bool, sf_db: VirchowSalesforceSQLite
    ) -> dict[str, str]:
        """
        ...
        # from import virchow.connectors.salesforce.sf_db.sqlite_functions find_ids_by_type
    ...
    #     parent_types: list[str], sf_client: VirchowSalesforce
    # ) -> set[str]:
    ...
    def _full_sync(
        ...
        sf_db = VirchowSalesforceSQLite(os.path.join(temp_dir, "salesforce_db.sqlite"))
        sf_db.connect()
    ...
    def _make_context(
        ...
        for parent_type in parent_types:
            # parent_virchow_sf_type = VirchowSalesforceType(parent_type, sf_client)
            ...
            for child_type, child_relationship in child_types_working.items():
                ...
                # virchow_sf_type = VirchowSalesforceType(child_type, sf_client)
        ...
        for sf_type in all_types:
            # virchow_sf_type = VirchowSalesforceType(sf_type, sf_client)
