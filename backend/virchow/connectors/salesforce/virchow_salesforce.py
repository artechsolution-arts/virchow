...
from virchow.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_OBJECTS
from virchow.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_PREFIXES
from virchow.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_SUFFIXES
...
class VirchowSalesforce(Salesforce):
    ...
    def get_child_objects_by_id(
        ...
        while True:
            ...
            if len(child_relationships_batch) >= VirchowSalesforce.SOQL_MAX_SUBQUERIES:
                process_batch = True
            ...
            if process_batch:
                ...
                query = VirchowSalesforce._make_child_objects_by_id_query(
                    object_id,
                    sf_type,
