...
from virchow.connectors.highspot.client import HighspotClient
from virchow.connectors.highspot.client import HighspotClientError
from virchow.connectors.highspot.utils import scrape_url_content
    ...
    def _get_item_content(self, item_details: Dict[str, Any]) -> str:
        ...
        try:
            if content_type == "WebLink":
                ...
                is_valid_format
                and file_extension in VirchowFileExtensions.TEXT_AND_DOCUMENT_EXTENSIONS
                and can_download
            ):
