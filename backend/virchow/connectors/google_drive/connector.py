...
from virchow.access.models import ExternalAccess
from virchow.configs.app_configs import GOOGLE_DRIVE_CONNECTOR_SIZE_THRESHOLD
from virchow.configs.app_configs import INDEX_BATCH_SIZE
from virchow.configs.app_configs import MAX_DRIVE_WORKERS
from virchow.configs.constants import DocumentSource
from virchow.connectors.exceptions import ConnectorValidationError
from virchow.connectors.exceptions import CredentialExpiredError
from virchow.connectors.exceptions import InsufficientPermissionsError
from virchow.connectors.google_drive.doc_conversion import build_slim_document
from virchow.connectors.google_drive.doc_conversion import (
    convert_drive_item_to_document,
)
from virchow.connectors.google_drive.doc_conversion import virchow_document_id_from_drive_file
from virchow.connectors.google_drive.doc_conversion import PermissionSyncContext
from virchow.connectors.google_drive.file_retrieval import crawl_folders_for_files
from virchow.connectors.google_drive.file_retrieval import DriveFileFieldType
from virchow.connectors.google_drive.file_retrieval import get_all_files_for_oauth
from virchow.connectors.google_drive.file_retrieval import (
    get_all_files_in_my_drive_and_shared,
)
from virchow.connectors.google_drive.file_retrieval import get_external_access_for_folder
from virchow.connectors.google_drive.file_retrieval import get_files_in_shared_drive
from virchow.connectors.google_drive.file_retrieval import get_folder_metadata
from virchow.connectors.google_drive.file_retrieval import get_root_folder_id
from virchow.connectors.google_drive.file_retrieval import get_shared_drive_name
from virchow.connectors.google_drive.file_retrieval import has_link_only_permission
from virchow.connectors.google_drive.models import DriveRetrievalStage
from virchow.connectors.google_drive.models import GoogleDriveCheckpoint
from virchow.connectors.google_drive.models import GoogleDriveFileType
from virchow.connectors.google_drive.models import RetrievedDriveFile
from virchow.connectors.google_drive.models import StageCompletion
from virchow.connectors.google_utils.google_auth import get_google_creds
from virchow.connectors.google_utils.google_utils import execute_paginated_retrieval
from virchow.connectors.google_utils.google_utils import get_file_owners
from virchow.connectors.google_utils.google_utils import GoogleFields
from virchow.connectors.google_utils.resources import get_admin_service
from virchow.connectors.google_utils.resources import get_drive_service
from virchow.connectors.google_utils.resources import GoogleDriveService
from virchow.connectors.google_utils.shared_constants import (
    DB_CREDENTIALS_PRIMARY_ADMIN_KEY,
)
from virchow.connectors.google_utils.shared_constants import MISSING_SCOPES_ERROR_STR
from virchow.connectors.google_utils.shared_constants import VIRCHOW_SCOPE_INSTRUCTIONS
from virchow.connectors.google_utils.shared_constants import SLIM_BATCH_SIZE
from virchow.connectors.google_utils.shared_constants import USER_FIELDS
from virchow.connectors.interfaces import CheckpointedConnectorWithPermSync
from virchow.connectors.interfaces import CheckpointOutput
from virchow.connectors.interfaces import GenerateSlimDocumentOutput
from virchow.connectors.interfaces import NormalizationResult
from virchow.connectors.interfaces import SecondsSinceUnixEpoch
from virchow.connectors.interfaces import SlimConnectorWithPermSync
from virchow.connectors.models import ConnectorFailure
from virchow.connectors.models import ConnectorMissingCredentialError
from virchow.connectors.models import Document
from virchow.connectors.models import EntityFailure
from virchow.connectors.models import HierarchyNode
from virchow.connectors.models import SlimDocument
from virchow.db.enums import HierarchyNodeType
from virchow.indexing.indexing_heartbeat import IndexingHeartbeatInterface
from virchow.utils.logger import setup_logger
from virchow.utils.retry_wrapper import retry_builder
from virchow.utils.threadpool_concurrency import parallel_yield
from virchow.utils.threadpool_concurrency import run_functions_tuples_in_parallel
from virchow.utils.threadpool_concurrency import ThreadSafeDict
from virchow.utils.threadpool_concurrency import ThreadSafeSet
...
class GoogleDriveConnector(
    ...
    def normalize_url(cls, url: str) -> NormalizationResult:
        ...
        virchow_document_id_from_drive_file.
        """
        parsed = urlparse(url)
        ...
        normalized = virchow_document_id_from_drive_file(file_obj).rstrip("/")
        return NormalizationResult(normalized_url=normalized, use_default=False)
    ...
    def _checkpointed_retrieval(
        ...
        for file in drive_files:
            ...
            try:
                document_id = virchow_document_id_from_drive_file(drive_file)
    ...
    def _load_from_checkpoint(
        ...
        try:
            ...
            if MISSING_SCOPES_ERROR_STR in str(e):
                raise PermissionError(VIRCHOW_SCOPE_INSTRUCTIONS) from e
            raise e
    ...
    def validate_connector_settings(self) -> None:
        ...
        try:
            ...
            if MISSING_SCOPES_ERROR_STR in str(e):
                raise InsufficientPermissionsError(
                    f"Google Drive credentials are missing required scopes. {VIRCHOW_SCOPE_INSTRUCTIONS}"
                )
            raise ConnectorValidationError(
