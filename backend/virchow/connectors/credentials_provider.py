...
class VirchowDBCredentialsProvider(
    CredentialsProviderInterface["VirchowDBCredentialsProvider"]
):
    ...
    def __enter__(self) -> "VirchowDBCredentialsProvider":
...
class VirchowStaticCredentialsProvider(
    CredentialsProviderInterface["VirchowStaticCredentialsProvider"]
):
    ...
    def __enter__(self) -> "VirchowStaticCredentialsProvider":
        return self
