...
from virchow.configs.app_configs import CONNECTOR_LOCALHOST_OVERRIDE
from virchow.configs.constants import DocumentSource
from virchow.configs.constants import IGNORE_FOR_QA
from virchow.connectors.models import BasicExpertInfo
from virchow.connectors.models import VirchowMetadata
from virchow.utils.logger import setup_logger
from virchow.utils.text_processing import is_valid_email
...
def process_virchow_metadata(
    metadata: dict[str, Any],
) -> tuple[VirchowMetadata, dict[str, Any]]:
    """
    Users may set Virchow metadata and custom tags in text files. https://docs.virchow.app/admins/connectors/official/file
