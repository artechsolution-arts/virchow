...
from virchow.configs.app_configs import DRUPAL_WIKI_ATTACHMENT_SIZE_THRESHOLD
...
from virchow.connectors.cross_connector_utils.rate_limit_wrapper import rate_limit_builder
from virchow.connectors.cross_connector_utils.rate_limit_wrapper import rl_requests
from virchow.connectors.drupal_wiki.models import DrupalWikiCheckpoint
from virchow.connectors.drupal_wiki.models import DrupalWikiPage
from virchow.connectors.drupal_wiki.models import DrupalWikiPageResponse
from virchow.connectors.drupal_wiki.models import DrupalWikiSpaceResponse
from virchow.connectors.drupal_wiki.utils import build_drupal_wiki_document_id
...
from virchow.file_processing.html_utils import parse_html_page_basic
...
class DrupalWikiConnector(
        ...
        **kwargs: Any,
        ...
        if deprecated_found:
            raise ConnectorValidationError(
                ...
                f"Please delete and recreate this connector, or contact Virchow support "
    ...
    def _validate_attachment_filetype(self, attachment: dict[str, Any]) -> bool:
        ...
        if file_extension in VirchowFileExtensions.ALL_ALLOWED_EXTENSIONS:
            return True
