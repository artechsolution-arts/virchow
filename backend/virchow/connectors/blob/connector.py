...
from virchow.configs.app_configs import BLOB_STORAGE_SIZE_THRESHOLD
from virchow.configs.app_configs import INDEX_BATCH_SIZE
from virchow.configs.constants import BlobType
            ...
            if authentication_method == "access_key":
                ...
                def _refresh_credentials() -> dict[str, str]:
                    ...
                    assumed_role_object = sts_client.assume_role(
                        RoleArn=role_arn,
                        RoleSessionName=f"virchow_blob_storage_{int(time.time())}",
                    )
    ...
    def _yield_blob_objects(
        ...
        for page in pages:
            ...
            for obj in page["Contents"]:
                ...
                # Handle image files
                if file_ext in VirchowFileExtensions.IMAGE_EXTENSIONS:
                ...
                try:
                    ...
                    virchow_metadata, custom_tags = process_virchow_metadata(
                        extraction_result.metadata
                    )
                    file_display_name = virchow_metadata.file_display_name or file_name
                    time_updated = virchow_metadata.doc_updated_at or last_modified
                    ...
                    source_type = virchow_metadata.source_type or DocumentSource(
