...
from virchow.configs.app_configs import NOTION_CONNECTOR_DISABLE_RECURSIVE_PAGE_LOOKUP
        ...
        try:
            ...
            if res.status_code == 404:
                ...
                logger.error(
                    ...
                    f"with the Virchow integration. Exact exception:\n\n{e}"
                )
            else:
                logger.exception(
            ...
            for result in data["results"]:
                ...
                if result_type == "ai_block":
                    logger.warning(
                        ...
                        f"(discussion: https://github.com/virchow-dot-app/virchow/issues/1053)"
                    )
                    continue
                ...
                if result_type == "unsupported":
                    logger.warning(
                        ...
                        f"(discussion: https://github.com/virchow-dot-app/virchow/issues/1230)"
                    )
                    continue
                ...
                if result_type == "external_object_instance_page":
                    logger.warning(
                        ...
                        f"(discussion: https://github.com/virchow-dot-app/virchow/issues/1761)"
                    )
                    continue
