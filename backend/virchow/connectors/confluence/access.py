...
def get_page_restrictions(
    ...
    Args:
        confluence_client: VirchowConfluence client instance
    ...
    ee_get_all_page_restrictions = cast(
        Callable[
            [VirchowConfluence, str, dict[str, Any], list[dict[str, Any]], bool],
            ExternalAccess | None,
        ],
        fetch_versioned_implementation(
            "virchow.external_permissions.confluence.page_access", "get_page_restrictions"
        ),
    )
...
def get_all_space_permissions(
    ...
    ee_get_all_space_permissions = cast(
        Callable[
            [VirchowConfluence, bool, bool],
            dict[str, ExternalAccess],
        ],
        fetch_versioned_implementation(
            "virchow.external_permissions.confluence.space_access",
