...
from virchow.configs.app_configs import CONFLUENCE_CONNECTOR_USER_PROFILES_OVERRIDE
from virchow.configs.app_configs import OAUTH_CONFLUENCE_CLOUD_CLIENT_ID
from virchow.configs.app_configs import OAUTH_CONFLUENCE_CLOUD_CLIENT_SECRET
from virchow.connectors.confluence.models import ConfluenceUser
from virchow.connectors.confluence.user_profile_override import (
    process_confluence_user_profiles_override,
)
from virchow.connectors.confluence.utils import _handle_http_error
from virchow.connectors.confluence.utils import confluence_refresh_tokens
from virchow.connectors.confluence.utils import get_start_param_from_url
from virchow.connectors.confluence.utils import update_param_in_path
from virchow.connectors.cross_connector_utils.miscellaneous_utils import scoped_url
from virchow.connectors.interfaces import CredentialsProviderInterface
from virchow.file_processing.html_utils import format_document_soup
    ...
    def _initialize_connection_helper(
        ...
        **kwargs: Any,
        ...
        if "confluence_refresh_token" in credentials:
            ...
            oauth2_dict: dict[str, Any] = VirchowConfluence._make_oauth2_dict(credentials)
...
def get_user_email_from_username__server(
    confluence_client: VirchowConfluence, user_name: str
) -> str | None:
...
def _get_user(confluence_client: VirchowConfluence, user_id: str) -> str:
