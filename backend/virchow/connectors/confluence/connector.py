...
from virchow.configs.app_configs import CONFLUENCE_CONNECTOR_LABELS_TO_SKIP
from virchow.configs.app_configs import CONFLUENCE_TIMEZONE_OFFSET
from virchow.configs.app_configs import CONTINUE_ON_CONNECTOR_FAILURE
from virchow.configs.app_configs import INDEX_BATCH_SIZE
from virchow.configs.constants import DocumentSource
from virchow.connectors.confluence.access import get_all_space_permissions
from virchow.connectors.confluence.access import get_page_restrictions
from virchow.connectors.confluence.virchow_confluence import extract_text_from_confluence_html
from virchow.connectors.confluence.virchow_confluence import VirchowConfluence
from virchow.connectors.confluence.utils import build_confluence_document_id
from virchow.connectors.confluence.utils import convert_attachment_to_content
from virchow.connectors.confluence.utils import datetime_from_string
from virchow.connectors.confluence.utils import update_param_in_path
from virchow.connectors.confluence.utils import validate_attachment_filetype
from virchow.connectors.credentials_provider import VirchowStaticCredentialsProvider
...
from virchow.connectors.interfaces import ConnectorCheckpoint
from virchow.connectors.interfaces import ConnectorFailure
from virchow.connectors.interfaces import CredentialsConnector
from virchow.connectors.interfaces import CredentialsProviderInterface
...
from virchow.connectors.interfaces import SlimConnector
from virchow.connectors.interfaces import SlimConnectorWithPermSync
from virchow.connectors.models import BasicExpertInfo
...
class ConfluenceConnector(
    ...
    def __init__(
        ...
        self._confluence_client: VirchowConfluence | None = None
        self._low_timeout_confluence_client: VirchowConfluence | None = None
    ...
    @property
    def confluence_client(self) -> VirchowConfluence:
        if self._confluence_client is None:
            raise ConnectorMissingCredentialError("Confluence")
        return self._confluence_client

    @property
    def low_timeout_confluence_client(self) -> VirchowConfluence:
    ...
    def set_credentials_provider(
        ...
        confluence_client = VirchowConfluence(
        ...
        low_timeout_confluence_client = VirchowConfluence(
            is_cloud=self.is_cloud,
            url=self.wiki_base,
            credentials_provider=credentials_provider,
            timeout=3,
...
if __name__ == "__main__":
    ...
    credentials_provider = VirchowStaticCredentialsProvider(
        None,
