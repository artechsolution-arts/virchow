...
from virchow.access.access import get_access_for_user_files
...
from virchow.db.user_file import fetch_chunk_counts_for_user_files
from virchow.db.user_file import fetch_persona_ids_for_user_files
from virchow.db.user_file import fetch_user_project_ids_for_user_files
...
from virchow.db.models import DocumentChunk, User, UserFile

class UserFileIndexingAdapter:
    def __init__(self, tenant_id: str, db_session: Session, user: User | None = None):
    ...
    def post_index(
        ...
        # Upsert chunks to Postgres for search/RBAC
