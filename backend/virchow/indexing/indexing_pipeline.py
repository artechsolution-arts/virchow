...
from virchow.configs.app_configs import DEFAULT_CONTEXTUAL_RAG_LLM_NAME
from virchow.configs.app_configs import DEFAULT_CONTEXTUAL_RAG_LLM_PROVIDER
from virchow.configs.app_configs import ENABLE_CONTEXTUAL_RAG
from virchow.configs.app_configs import MAX_DOCUMENT_CHARS
from virchow.configs.app_configs import MAX_TOKENS_FOR_FULL_INCLUSION
from virchow.configs.app_configs import USE_CHUNK_SUMMARY
from virchow.configs.app_configs import USE_DOCUMENT_SUMMARY
...
from virchow.connectors.models import DocumentFailure
from virchow.connectors.models import ImageSection
from virchow.connectors.models import IndexAttemptMetadata
from virchow.connectors.models import IndexingDocument
from virchow.connectors.models import Section
from virchow.connectors.models import TextSection
from virchow.db.document import get_documents_by_ids
from virchow.db.document import upsert_document_by_connector_credential_pair
from virchow.db.document import upsert_documents
from virchow.db.hierarchy import link_hierarchy_nodes_to_documents
from virchow.db.models import Document as DBDocument
from virchow.db.models import IndexModelStatus
from virchow.db.search_settings import get_active_search_settings
from virchow.db.tag import upsert_document_tags
from virchow.document_index.document_index_utils import (
    get_multipass_config,
)
from virchow.document_index.interfaces import DocumentIndex
from virchow.document_index.interfaces import DocumentInsertionRecord
from virchow.document_index.interfaces import DocumentMetadata
from virchow.document_index.interfaces import IndexBatchParams
from virchow.file_processing.image_summarization import summarize_image_with_error_handling
from virchow.file_store.file_store import get_default_file_store
from virchow.indexing.chunker import Chunker
from virchow.indexing.embedder import embed_chunks_with_failure_handling
from virchow.indexing.embedder import IndexingEmbedder
from virchow.indexing.models import DocAwareChunk
from virchow.indexing.models import IndexingBatchAdapter
from virchow.indexing.models import UpdatableChunkData
from virchow.indexing.vector_db_insertion import write_chunks_to_vector_db_with_backoff
from virchow.llm.factory import get_default_llm_with_vision
from virchow.llm.factory import get_llm_for_contextual_rag
from virchow.llm.interfaces import LLM
from virchow.llm.models import UserMessage
from virchow.llm.multi_llm import LLMRateLimitError
from virchow.llm.utils import llm_response_to_string
from virchow.llm.utils import MAX_CONTEXT_TOKENS
from virchow.natural_language_processing.utils import BaseTokenizer
from virchow.natural_language_processing.utils import get_tokenizer
from virchow.natural_language_processing.utils import tokenizer_trim_middle
from virchow.prompts.contextual_retrieval import CONTEXTUAL_RAG_PROMPT1
from virchow.prompts.contextual_retrieval import CONTEXTUAL_RAG_PROMPT2
from virchow.prompts.contextual_retrieval import DOCUMENT_SUMMARY_PROMPT
from virchow.utils.logger import setup_logger
from virchow.utils.postgres_sanitization import sanitize_documents_for_postgres
...
def add_chunk_summaries(
    ...
    from virchow.llm.prompt_cache.processor import process_with_prompt_cache
