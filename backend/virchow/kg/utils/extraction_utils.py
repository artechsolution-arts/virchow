...
from virchow.configs.constants import VirchowCallTypes
from virchow.configs.kg_configs import KG_METADATA_TRACKING_THRESHOLD
from virchow.db.engine.sql_engine import get_session_with_current_tenant
from virchow.db.entities import get_kg_entity_by_document
from virchow.db.entity_type import get_entity_types
from virchow.db.kg_config import KGConfigSettings
...
from virchow.db.tag import get_structured_tags_for_document
from virchow.kg.models import KGAttributeEntityOption
from virchow.kg.models import KGAttributeTrackInfo
from virchow.kg.models import KGAttributeTrackType
from virchow.kg.models import KGChunkFormat
from virchow.kg.models import KGClassificationInstructions
from virchow.kg.models import KGClassificationResult
from virchow.kg.models import KGDocumentDeepExtractionResults
from virchow.kg.models import KGEnhancedDocumentMetadata
from virchow.kg.models import KGImpliedExtractionResults
from virchow.kg.models import KGMetadataContent
from virchow.kg.utils.formatting_utils import extract_email
from virchow.kg.utils.formatting_utils import get_entity_type
from virchow.kg.utils.formatting_utils import kg_email_processing
from virchow.kg.utils.formatting_utils import make_entity_id
from virchow.kg.utils.formatting_utils import make_relationship_id
from virchow.kg.utils.formatting_utils import make_relationship_type_id
from virchow.kg.vespa.vespa_interactions import get_document_vespa_contents
...
from virchow.prompts.kg_prompts import CALL_CHUNK_PREPROCESSING_PROMPT
from virchow.prompts.kg_prompts import CALL_DOCUMENT_CLASSIFICATION_PROMPT
from virchow.prompts.kg_prompts import GENERAL_CHUNK_PREPROCESSING_PROMPT
from virchow.prompts.kg_prompts import MASTER_EXTRACTION_PROMPT
...
def kg_implied_extraction(
    ...
    document_is_from_call = document_entity_type.lower() in (
        call_type.value.lower() for call_type in VirchowCallTypes
    )
...
def kg_classify_document(
    ...
    if entity_type not in (call_type.value for call_type in VirchowCallTypes):
        return None
...
def kg_deep_extract_chunks(
    ...
    entity_type = get_entity_type(document_entity)
    is_call = entity_type in (call_type.value for call_type in VirchowCallTypes)
