...
from virchow.configs.constants import NUM_DAYS_TO_KEEP_CHECKPOINTS
...
from virchow.utils.object_size_check import deep_getsizeof
...
def get_latest_valid_checkpoint(
    ...
    checkpoint_candidates = [
        ...
        if (
            ...
            # chat channels, and many of them don't have any updates.
