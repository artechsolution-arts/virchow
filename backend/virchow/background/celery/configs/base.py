...
from virchow.configs.app_configs import CELERY_BROKER_POOL_LIMIT
from virchow.configs.app_configs import CELERY_RESULT_EXPIRES
from virchow.configs.app_configs import REDIS_DB_NUMBER_CELERY
from virchow.configs.app_configs import REDIS_DB_NUMBER_CELERY_RESULT_BACKEND
...
broker_transport_options = {
    "priority_steps": list(range(len(VirchowCeleryPriority))),
...
task_default_priority = VirchowCeleryPriority.MEDIUM
task_acks_late = True
