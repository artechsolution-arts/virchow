...
from virchow.configs.constants import POSTGRES_CELERY_WORKER_MONITORING_APP_NAME
...
celery_app.config_from_object("virchow.background.celery.configs.monitoring")
...
celery_app.autodiscover_tasks(
    app_base.filter_task_modules(
        [
            "virchow.background.celery.tasks.monitoring",
        ]
    )
)
