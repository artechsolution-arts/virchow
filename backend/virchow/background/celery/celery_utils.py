...
from virchow.configs.app_configs import MAX_PRUNING_DOCUMENT_RETRIEVAL_PER_MINUTE
from virchow.configs.app_configs import VESPA_REQUEST_TIMEOUT
from virchow.connectors.connector_runner import CheckpointOutputWrapper
...
def make_probe_path(probe: str, hostname: str) -> Path:
    ...
    e.g. /tmp/virchow_k8s_indexing_readiness.txt
    """
    ...
    return Path(f"/tmp/virchow_k8s_{safe_name}_{probe}.txt")
