# Overview of Virchow Background Jobs
...
Watchdog is a separate Python process managed by supervisord which runs alongside celery workers. It checks the VIRCHOW_CELERY_BEAT_HEARTBEAT_KEY in
...
- Memory of supervisor managed processes (workers, beat)
