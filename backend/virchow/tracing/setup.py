...
from virchow.configs.app_configs import BRAINTRUST_API_KEY
from virchow.configs.app_configs import BRAINTRUST_PROJECT
from virchow.configs.app_configs import LANGFUSE_HOST
from virchow.configs.app_configs import LANGFUSE_PUBLIC_KEY
from virchow.configs.app_configs import LANGFUSE_SECRET_KEY
...
def _setup_braintrust() -> None:
    ...
    from virchow.tracing.braintrust_tracing_processor import BraintrustTracingProcessor
    from virchow.tracing.framework import add_trace_processor
    from virchow.tracing.masking import mask_sensitive_data
...
def _setup_langfuse() -> None:
    ...
    from virchow.tracing.framework import add_trace_processor
    from virchow.tracing.langfuse_tracing_processor import LangfuseTracingProcessor
