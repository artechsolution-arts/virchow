...
from virchow.virchowbot.discord.constants import CACHE_REFRESH_INTERVAL
...
from virchow.virchowbot.discord.handle_message import should_respond
...
class VirchowDiscordClient(commands.Bot):
    ...
    def __init__(self, command_prefix: str = DISCORD_BOT_INVOKE_CHAR) -> None:
        ...
        self.api_client = VirchowAPIClient()
...
def main() -> None:
    ...
    logger.info("Starting Virchow Discord Bot...")
