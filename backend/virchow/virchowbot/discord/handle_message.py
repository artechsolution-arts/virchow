...
from virchow.db.discord_bot import get_channel_config_by_discord_ids
...
from virchow.db.models import DiscordChannelConfig
from virchow.db.models import DiscordGuildConfig
from virchow.virchowbot.discord.api_client import VirchowAPIClient
from virchow.virchowbot.discord.constants import MAX_CONTEXT_MESSAGES
from virchow.virchowbot.discord.constants import MAX_MESSAGE_LENGTH
from virchow.virchowbot.discord.constants import THINKING_EMOJI
from virchow.virchowbot.discord.exceptions import APIError
...
def _format_messages_as_context(
    ...
    for msg in messages:
        ...
        sender = (
            "VirchowBot" if msg.author.id == bot_user.id else f"@{msg.author.display_name}"
        )
    ...
    return (
        "You are a Discord bot named VirchowBot.\n"
...
async def send_response(
    ...
    if isinstance(message.channel, discord.Thread):
        ...
        thread_name = f"VirchowBot <> {message.author.display_name}"[:100]
...
async def send_error_response(
    ...
    error_msg = "Sorry, I encountered an error processing your message. You may want to contact Virchow for support :sweat_smile:"
