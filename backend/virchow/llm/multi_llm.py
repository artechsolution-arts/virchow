...
from virchow.configs.app_configs import MOCK_LLM_RESPONSE
from virchow.configs.chat_configs import LLM_SOCKET_READ_TIMEOUT
from virchow.configs.model_configs import GEN_AI_TEMPERATURE
from virchow.configs.model_configs import LITELLM_EXTRA_BODY
from virchow.llm.constants import LlmProviderNames
from virchow.llm.cost import calculate_llm_cost_cents
from virchow.llm.interfaces import LanguageModelInput
...
from virchow.llm.interfaces import ReasoningEffort
from virchow.llm.interfaces import ToolChoiceOptions
from virchow.llm.model_response import ModelResponse
from virchow.llm.model_response import ModelResponseStream
from virchow.llm.model_response import Usage
from virchow.llm.models import ANTHROPIC_REASONING_EFFORT_BUDGET
from virchow.llm.models import OPENAI_REASONING_EFFORT
from virchow.llm.request_context import get_llm_mock_response
from virchow.llm.utils import build_litellm_passthrough_kwargs
from virchow.llm.utils import is_true_openai_model
from virchow.llm.utils import model_is_reasoning_model
from virchow.llm.well_known_providers.constants import AWS_ACCESS_KEY_ID_KWARG
from virchow.llm.well_known_providers.constants import (
    AWS_ACCESS_KEY_ID_KWARG_ENV_VAR_FORMAT,
)
from virchow.llm.well_known_providers.constants import (
    AWS_BEARER_TOKEN_BEDROCK_KWARG_ENV_VAR_FORMAT,
)
from virchow.llm.well_known_providers.constants import AWS_REGION_NAME_KWARG
from virchow.llm.well_known_providers.constants import AWS_REGION_NAME_KWARG_ENV_VAR_FORMAT
from virchow.llm.well_known_providers.constants import AWS_SECRET_ACCESS_KEY_KWARG
from virchow.llm.well_known_providers.constants import (
...
from virchow.llm.well_known_providers.constants import OLLAMA_API_KEY_CONFIG_KEY
from virchow.llm.well_known_providers.constants import VERTEX_CREDENTIALS_FILE_KWARG
from virchow.llm.well_known_providers.constants import (
    VERTEX_CREDENTIALS_FILE_KWARG_ENV_VAR_FORMAT,
)
from virchow.llm.well_known_providers.constants import VERTEX_LOCATION_KWARG
from virchow.utils.encryption import mask_string
...
class LitellmLLM(LLM):
    ...
    def _track_llm_cost(self, usage: Usage) -> None:
        """
        Track LLM usage cost for Virchow-managed API keys.
        ...
        2. The API key is one of Virchow's managed default keys
        """
        ...
        from virchow.server.usage_limits import is_virchow_managed_api_key

        if not is_virchow_managed_api_key(self._api_key):
            return
    ...
    def _completion(
        ...
        from virchow.llm.litellm_singleton import litellm
    ...
    def invoke(
        ...
        from virchow.llm.model_response import from_litellm_model_response
        ...
        try:
            ...
            # Track LLM cost for Virchow-managed API keys
    ...
    def stream(
        ...
        from virchow.llm.model_response import from_litellm_model_response_stream
