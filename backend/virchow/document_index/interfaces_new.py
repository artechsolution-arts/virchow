...
# document as represented in Virchow. What is actually stored in the index is the
...
class IndexRetrievalFilters(BaseModel):
    ...
    Used to filter on permissions and other Virchow-specific metadata rather than
...
class DocumentIndex(
    ...
    """
    A valid document index that can plug into all Virchow flows must implement all
