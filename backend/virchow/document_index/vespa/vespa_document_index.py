...
from virchow.configs.app_configs import RECENCY_BIAS_MULTIPLIER
from virchow.configs.app_configs import RERANK_COUNT
from virchow.configs.chat_configs import DOC_TIME_DECAY
...
from virchow.document_index.document_index_utils import get_document_chunk_ids
from virchow.document_index.document_index_utils import get_uuid_from_chunk_info
from virchow.document_index.interfaces import EnrichedDocumentIndexingInfo
from virchow.document_index.interfaces import MinimalDocumentIndexingInfo
...
from virchow.document_index.vespa.chunk_retrieval import batch_search_api_retrieval
from virchow.document_index.vespa.chunk_retrieval import get_all_chunks_paginated
from virchow.document_index.vespa.chunk_retrieval import get_chunks_via_visit_api
from virchow.document_index.vespa.chunk_retrieval import (
    parallel_visit_api_retrieval,
)
from virchow.document_index.vespa.chunk_retrieval import query_vespa
from virchow.document_index.vespa.deletion import delete_vespa_chunks
from virchow.document_index.vespa.indexing_utils import BaseHTTPXClientContext
from virchow.document_index.vespa.indexing_utils import batch_index_vespa_chunks
from virchow.document_index.vespa.indexing_utils import check_for_final_chunk_existence
from virchow.document_index.vespa.indexing_utils import clean_chunk_id_copy
from virchow.document_index.vespa.indexing_utils import GlobalHTTPXClientContext
from virchow.document_index.vespa.indexing_utils import TemporaryHTTPXClientContext
from virchow.document_index.vespa.shared_utils.utils import get_vespa_http_client
from virchow.document_index.vespa.shared_utils.utils import (
    replace_invalid_doc_id_characters,
)
from virchow.document_index.vespa.shared_utils.vespa_request_builders import (
    build_vespa_filters,
)
from virchow.document_index.vespa_constants import BATCH_SIZE
from virchow.document_index.vespa_constants import CHUNK_ID
from virchow.document_index.vespa_constants import CONTENT_SUMMARY
...
from virchow.document_index.vespa_constants import NUM_THREADS
from virchow.document_index.vespa_constants import SEARCH_ENDPOINT
from virchow.document_index.vespa_constants import VESPA_TIMEOUT
from virchow.document_index.vespa_constants import YQL_BASE
from virchow.indexing.models import DocMetadataAwareIndexChunk
from virchow.tools.tool_implementations.search.constants import KEYWORD_QUERY_HYBRID_ALPHA
from virchow.utils.batching import batch_generator
...
def _update_single_chunk(
    ...
    class _VespaPutFields(BaseModel):
        ...
        # backend/virchow/document_index/vespa_constants.py.
