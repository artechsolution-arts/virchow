...
from virchow.document_index.disabled import DisabledDocumentIndex
...
def get_default_document_index(
    ...
    if opensearch_retrieval_enabled:
        ...
        from virchow.document_index.pgvector.index import PgvectorIndex
        return PgvectorIndex(db_session=db_session)
...
def get_all_document_indices(
    ...
    ENABLE_OPENSEARCH_INDEXING_FOR_VIRCHOW is True. This is so we don't break flows
