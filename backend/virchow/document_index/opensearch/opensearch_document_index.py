...
from virchow.configs.app_configs import VERIFY_CREATE_OPENSEARCH_INDEX_ON_INIT_MT
from virchow.configs.chat_configs import NUM_RETURNED_HITS
from virchow.configs.chat_configs import TITLE_CONTENT_RATIO
from virchow.configs.constants import PUBLIC_DOC_PAT
from virchow.connectors.cross_connector_utils.miscellaneous_utils import (
    get_experts_stores_representations,
)
from virchow.connectors.models import convert_metadata_list_of_strings_to_dict
...
from virchow.context.search.models import InferenceChunkUncleaned
from virchow.context.search.models import QueryExpansionType
from virchow.db.enums import EmbeddingPrecision
from virchow.db.models import DocumentSource
from virchow.document_index.chunk_content_enrichment import cleanup_content_for_chunks
from virchow.document_index.chunk_content_enrichment import (
    generate_enriched_content_for_chunk_text,
)
from virchow.document_index.interfaces import DocumentIndex as OldDocumentIndex
from virchow.document_index.interfaces import (
    DocumentInsertionRecord as OldDocumentInsertionRecord,
)
from virchow.document_index.interfaces import IndexBatchParams
...
from virchow.document_index.interfaces_new import DocumentIndex
from virchow.document_index.interfaces_new import DocumentInsertionRecord
from virchow.document_index.interfaces_new import DocumentSectionRequest
from virchow.document_index.interfaces_new import IndexingMetadata
from virchow.document_index.interfaces_new import MetadataUpdateRequest
...
from virchow.document_index.opensearch.client import SearchHit
from virchow.document_index.opensearch.cluster_settings import OPENSEARCH_CLUSTER_SETTINGS
from virchow.document_index.opensearch.schema import ACCESS_CONTROL_LIST_FIELD_NAME
from virchow.document_index.opensearch.schema import CONTENT_FIELD_NAME
from virchow.document_index.opensearch.schema import DOCUMENT_SETS_FIELD_NAME
from virchow.document_index.opensearch.schema import DocumentChunk
from virchow.document_index.opensearch.schema import DocumentSchema
from virchow.document_index.opensearch.schema import get_opensearch_doc_chunk_id
from virchow.document_index.opensearch.schema import GLOBAL_BOOST_FIELD_NAME
from virchow.document_index.opensearch.schema import HIDDEN_FIELD_NAME
from virchow.document_index.opensearch.schema import PERSONAS_FIELD_NAME
from virchow.document_index.opensearch.schema import USER_PROJECTS_FIELD_NAME
from virchow.document_index.opensearch.search import DocumentQuery
from virchow.document_index.opensearch.search import (
...
from virchow.indexing.models import Document
from virchow.utils.logger import setup_logger
from virchow.utils.text_processing import remove_invalid_unicode_chars
...
def set_cluster_state(client: OpenSearchClient) -> None:
    if not client.put_cluster_settings(settings=OPENSEARCH_CLUSTER_SETTINGS):
        logger.error(
            ...
            "is not the first time running Virchow against this instance of OpenSearch, these "
...
def _convert_retrieved_opensearch_chunk_to_inference_chunk_uncleaned(
    ...
    Returns:
        An Virchow inference chunk representation.
    """
...
def _convert_virchow_chunk_to_opensearch_document(
    ...
    def index(
        ...
        for _, chunks in doc_id_to_chunks.items():
            ...
            chunk_batch: list[DocumentChunk] = [
                _convert_virchow_chunk_to_opensearch_document(chunk) for chunk in chunks
            ]
            virchow_document: Document = chunks[0].source_document
    ...
    def delete(
        ...
        Args:
            document_id: The unique identifier for the document as represented
                in Virchow, not necessarily in the document index.
