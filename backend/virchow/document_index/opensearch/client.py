...
from virchow.configs.app_configs import DEFAULT_OPENSEARCH_CLIENT_TIMEOUT_S
from virchow.configs.app_configs import OPENSEARCH_ADMIN_PASSWORD
from virchow.configs.app_configs import OPENSEARCH_ADMIN_USERNAME
from virchow.configs.app_configs import OPENSEARCH_HOST
from virchow.configs.app_configs import OPENSEARCH_REST_API_PORT
...
from virchow.document_index.opensearch.search import DEFAULT_OPENSEARCH_MAX_RESULT_WINDOW
...
class OpenSearchIndexClient(OpenSearchClient):
    ...
    most methods here return the minimum data needed for the rest of Virchow, and
    ...
    def index_document(
        ...
        Args:
            document: The document to index. In Virchow this is a chunk of a
    ...
    def bulk_index_documents(
        ...
        Args:
            documents: The documents to index. In Virchow this is a chunk of a
                document, OpenSearch simply refers to this as a document as
                well.
            tenant_state: The tenant state of the caller.
            update_if_exists: Whether to update the document if it already
