...
from virchow.chat.models import ChatHistoryResult
...
from virchow.configs.constants import TMP_DRALPHA_PERSONA_NAME
from virchow.db.chat import create_chat_session
...
from virchow.db.kg_config import is_kg_config_settings_enabled_valid
from virchow.db.models import ChatMessage
from virchow.db.models import ChatSession
from virchow.db.models import Persona
from virchow.db.models import SearchDoc as DbSearchDoc
from virchow.db.models import UserFile
from virchow.db.projects import check_project_ownership
...
from virchow.kg.models import KGException
from virchow.kg.setup.kg_default_entity_definitions import (
    populate_missing_default_entity_types__commit,
)
from virchow.prompts.chat_prompts import ADDITIONAL_CONTEXT_PROMPT
from virchow.prompts.chat_prompts import TOOL_CALL_RESPONSE_CROSS_MESSAGE
from virchow.prompts.tool_prompts import TOOL_CALL_FAILURE_PROMPT
...
def reorganize_citations(
    ...
    def reformat_link(match: re.Match) -> str:
    ...
    new_answer = re.sub(pattern, reformat_link, answer)
