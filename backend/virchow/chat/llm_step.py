...
from virchow.chat.tool_call_args_streaming import maybe_emit_argument_delta
from virchow.configs.app_configs import LOG_VIRCHOW_MODEL_INTERACTIONS
from virchow.configs.app_configs import PROMPT_CACHE_CHAT_HISTORY
...
from virchow.llm.model_response import Delta
from virchow.llm.models import AssistantMessage
from virchow.llm.models import ChatCompletionMessage
from virchow.llm.models import FunctionCall
from virchow.llm.models import ImageContentPart
from virchow.llm.models import ImageUrlDetail
from virchow.llm.models import ReasoningEffort
from virchow.llm.models import SystemMessage
from virchow.llm.models import TextContentPart
from virchow.llm.models import ToolCall
from virchow.llm.models import ToolMessage
from virchow.llm.models import UserMessage
from virchow.llm.prompt_cache.processor import process_with_prompt_cache
from virchow.llm.utils import model_needs_formatting_reenabled
from virchow.prompts.chat_prompts import CODE_BLOCK_MARKDOWN
from virchow.prompts.constants import SYSTEM_REMINDER_TAG_CLOSE
from virchow.prompts.constants import SYSTEM_REMINDER_TAG_OPEN
...
from virchow.server.query_and_chat.streaming_models import ReasoningDone
...
from virchow.tracing.framework.create import generation_span
from virchow.utils.b64 import get_image_type_from_bytes
from virchow.utils.jsonriver import Parser
from virchow.utils.logger import setup_logger
from virchow.utils.postgres_sanitization import sanitize_string
from virchow.utils.text_processing import find_all_json_objects
...
def run_llm_step_pkt_generator(
    ...
    if LOG_VIRCHOW_MODEL_INTERACTIONS:
        logger.debug(
