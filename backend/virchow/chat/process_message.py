...
from virchow.cache.interface import CacheBackend
from virchow.chat.chat_processing_checker import set_processing_status
from virchow.chat.chat_state import ChatStateContainer
from virchow.chat.chat_state import run_chat_loop_with_state_containers
from virchow.chat.chat_utils import convert_chat_history
from virchow.chat.chat_utils import create_chat_history_chain
from virchow.chat.chat_utils import create_chat_session_from_request
from virchow.chat.chat_utils import get_custom_agent_prompt
from virchow.chat.chat_utils import is_last_assistant_message_clarification
from virchow.chat.chat_utils import load_all_chat_files
from virchow.chat.compression import calculate_total_history_tokens
from virchow.chat.compression import compress_chat_history
from virchow.chat.compression import find_summary_for_branch
from virchow.chat.compression import get_compression_params
from virchow.chat.emitter import get_default_emitter
from virchow.chat.llm_loop import EmptyLLMResponseError
from virchow.chat.llm_loop import run_llm_loop
from virchow.chat.models import AnswerStream
from virchow.chat.models import ChatBasicResponse
from virchow.chat.models import ChatFullResponse
from virchow.chat.models import ChatLoadedFile
from virchow.chat.models import ChatMessageSimple
from virchow.chat.models import ContextFileMetadata
from virchow.chat.models import CreateChatSessionID
from virchow.chat.models import ExtractedContextFiles
from virchow.chat.models import FileToolMetadata
from virchow.chat.models import SearchParams
from virchow.chat.models import StreamingError
from virchow.chat.models import ToolCallResponse
from virchow.chat.prompt_utils import calculate_reserved_tokens
from virchow.chat.save_chat import save_chat_turn
from virchow.chat.stop_signal_checker import is_connected as check_stop_signal
from virchow.chat.stop_signal_checker import reset_cancel_status
from virchow.configs.app_configs import DISABLE_VECTOR_DB
from virchow.configs.app_configs import INTEGRATION_TESTS_MODE
from virchow.configs.constants import DEFAULT_PERSONA_ID
...
from virchow.db.chat import create_new_chat_message
from virchow.db.chat import get_chat_session_by_id
from virchow.db.chat import get_or_create_root_message
from virchow.db.chat import reserve_message_id
from virchow.db.memory import get_memories
from virchow.db.models import ChatMessage
from virchow.db.models import ChatSession
from virchow.db.models import Persona
from virchow.db.models import User
from virchow.db.models import UserFile
from virchow.db.projects import get_user_files_from_project
from virchow.db.tools import get_tools

from virchow.file_processing.extract_file_text import extract_file_text
from virchow.file_store.models import ChatFileType
from virchow.file_store.models import InMemoryChatFile
from virchow.file_store.utils import load_in_memory_chat_files
from virchow.file_store.utils import verify_user_files
from virchow.llm.factory import get_llm_for_persona
from virchow.llm.factory import get_llm_token_counter
from virchow.llm.interfaces import LLM
from virchow.llm.interfaces import LLMUserIdentity
from virchow.llm.request_context import reset_llm_mock_response
from virchow.llm.request_context import set_llm_mock_response
from virchow.llm.utils import litellm_exception_to_error_msg
from virchow.server.query_and_chat.models import AUTO_PLACE_AFTER_LATEST_MESSAGE
from virchow.server.query_and_chat.models import MessageResponseIDInfo
from virchow.server.query_and_chat.models import SendMessageRequest
from virchow.server.query_and_chat.streaming_models import AgentResponseDelta
from virchow.server.query_and_chat.streaming_models import AgentResponseStart
from virchow.server.query_and_chat.streaming_models import CitationInfo
from virchow.server.query_and_chat.streaming_models import Packet
from virchow.server.usage_limits import check_llm_cost_limit_for_provider
from virchow.tools.constants import SEARCH_TOOL_ID
from virchow.tools.interface import Tool
from virchow.tools.models import ChatFile
from virchow.tools.models import SearchToolUsage
from virchow.tools.tool_constructor import construct_tools
from virchow.tools.tool_constructor import CustomToolConfig
from virchow.tools.tool_constructor import FileReaderToolConfig
from virchow.tools.tool_constructor import SearchToolConfig
from virchow.tools.tool_implementations.file_reader.file_reader_tool import (
    FileReaderTool,
)
...
def handle_stream_message_objects(
    ...
    try:
        ...
        # Check LLM cost limits before using the LLM (only for Virchow-managed keys)
        ...
        # (run_llm_loop) should not need to be aware of the Chat History in the DB form processed
