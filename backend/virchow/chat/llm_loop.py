...
from virchow.chat.chat_utils import create_tool_call_failure_messages
from virchow.chat.citation_processor import CitationMapping
from virchow.chat.citation_processor import CitationMode
from virchow.chat.citation_processor import DynamicCitationProcessor
from virchow.chat.citation_utils import update_citation_processor_from_tool_response
from virchow.chat.emitter import Emitter
from virchow.chat.llm_step import extract_tool_calls_from_response_text
from virchow.chat.llm_step import run_llm_step
...
from virchow.chat.models import LlmStepResult
from virchow.chat.models import ToolCallSimple
from virchow.chat.prompt_utils import build_reminder_message
from virchow.chat.prompt_utils import build_system_prompt
from virchow.chat.prompt_utils import (
...
from virchow.context.search.models import SearchDocsResponse
from virchow.db.engine.sql_engine import get_session_with_current_tenant
from virchow.db.memory import add_memory
from virchow.db.memory import update_memory_at_index
from virchow.db.memory import UserMemoryContext
...
from virchow.llm.interfaces import ToolChoiceOptions
from virchow.llm.utils import is_true_openai_model

from virchow.prompts.chat_prompts import OPEN_URL_REMINDER
...
from virchow.server.query_and_chat.streaming_models import ToolCallDebug
from virchow.server.query_and_chat.streaming_models import TopLevelBranching
from virchow.tools.built_in_tools import CITEABLE_TOOLS_NAMES
from virchow.tools.built_in_tools import STOPPING_TOOLS_NAMES
from virchow.tools.interface import Tool
from virchow.tools.models import ChatFile
from virchow.tools.models import CustomToolCallSummary
from virchow.tools.models import MemoryToolResponseSnapshot
from virchow.tools.models import PythonToolRichResponse
from virchow.tools.models import ToolCallInfo
from virchow.tools.models import ToolCallKickoff
from virchow.tools.models import ToolResponse

from virchow.tools.tool_implementations.memory.models import MemoryToolResponse
...
from virchow.tools.tool_implementations.web_search.utils import extract_url_snippet_map
from virchow.tools.tool_implementations.web_search.web_search_tool import WebSearchTool
from virchow.tools.tool_runner import run_tool_calls
from virchow.tracing.framework.create import trace
...
def run_llm_loop(
    ...
    with trace(
        ...
        from virchow.llm.litellm_singleton.config import (
            initialize_litellm,
        ...
        for llm_cycle_count in range(MAX_LLM_CYCLES):
            ...
            if just_ran_web_search and not out_of_cycles:
