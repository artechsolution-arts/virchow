...
from virchow.configs.app_configs import USE_IAM_AUTH
...
from virchow.configs.constants import SSL_CERT_FILE
from shared_configs.configs import (
    MULTI_TENANT,
    POSTGRES_DEFAULT_SCHEMA,
    TENANT_ID_PREFIX,
)
from virchow.db.models import Base
...
def provide_iam_token_for_alembic(
    ...
    if USE_IAM_AUTH:
        from virchow.db.engine.iam_auth import get_iam_auth_token
