<!-- VIRCHOW_METADATA={"link": "https://github.com/virchow-dot-app/virchow/blob/main/backend/alembic/README.md"} -->

# Alembic DB Migrations

These files are for creating/updating the tables in the Relational DB (Postgres).
Virchow migrations use a generic single-database configuration with an async dbapi.

## To generate new migrations:

From virchow/backend, run:
