...
from virchow.db.index_attempt import (
...
from virchow.document_index.factory import (
...
def _delete_connector(cc_pair_id: int, db_session: Session) -> None:
    user_input = input(
        ...
        IT MAY CAUSE ISSUES with your Virchow instance! \
