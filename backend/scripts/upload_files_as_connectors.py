"""
Script to upload files from a directory as individual file connectors in Virchow.
...
Usage:
    ...
    python upload_files_as_connectors.py --data-dir /path/to/files --api-key YOUR_KEY --api-base http://virchowserver:3000
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Upload files as individual Virchow file connectors."
    )
    parser.add_argument(
        "--data-dir",
        required=True,
    ...
    parser.add_argument(
        ...
        help="Base URL for the Virchow API (default: http://localhost:3000).",
    )
    parser.add_argument(
        "--api-key",
        required=True,
