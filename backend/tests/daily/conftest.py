...
# TODO(Nik): https://linear.app/virchow-app/issue/ENG-1/update-test-infra-to-use-test-license
...
from virchow.main import get_application
...
def client() -> Generator[TestClient, None, None]:
    ...
    with patch("virchow.main.setup_prometheus_metrics"):
