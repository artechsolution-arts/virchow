...
from virchow.connectors.gmail.connector import GmailConnector
...
from tests.unit.virchow.connectors.utils import load_everything_from_checkpoint_connector
...
This thread was 4 emails long:
    admin@virchow-test.com -> test-group-1@virchow-test.com (conaining test_user_1 and test_user_2)
    test_user_1@virchow-test.com -> admin@virchow-test.com
    admin@virchow-test.com -> test_user_2@virchow-test.com + BCC: test_user_3@virchow-test.com
    test_user_3@virchow-test.com -> admin@virchow-test.com
"""
_THREAD_1_BY_ID: dict[str, dict[str, Any]] = {
    "192edefb315737c3": {
        "email": "admin@virchow-test.com",
        "sections_count": 4,
        "primary_owners": set(
            [
                "admin@virchow-test.com",
                "test_user_1@virchow-test.com",
                "test_user_3@virchow-test.com",
            ]
        ),
        "secondary_owners": set(
            [
                "test-group-1@virchow-test.com",
                "admin@virchow-test.com",
                "test_user_2@virchow-test.com",
                "test_user_3@virchow-test.com",
            ]
        ),
    },
    "192edf020d2f5def": {
        "email": "test_user_1@virchow-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@virchow-test.com", "test_user_1@virchow-test.com"]),
        "secondary_owners": set(["test-group-1@virchow-test.com", "admin@virchow-test.com"]),
    },
    "192edf020ae90aab": {
        "email": "test_user_2@virchow-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@virchow-test.com"]),
        "secondary_owners": set(
            ["test-group-1@virchow-test.com", "test_user_2@virchow-test.com"]
        ),
    },
    "192edf18316015fa": {
        "email": "test_user_3@virchow-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@virchow-test.com", "test_user_3@virchow-test.com"]),
        "secondary_owners": set(
            [
                "admin@virchow-test.com",
                "test_user_2@virchow-test.com",
...
@patch(
    "virchow.file_processing.extract_file_text.get_unstructured_api_key",
    return_value=None,
)
