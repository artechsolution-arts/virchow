...
from ee.virchow.external_permissions.google_drive.doc_sync import gdrive_doc_sync
from ee.virchow.external_permissions.google_drive.group_sync import gdrive_group_sync
from virchow.access.models import DocExternalAccess
from virchow.connectors.google_drive.connector import GoogleDriveConnector
...
def test_gdrive_perm_sync_with_real_data(
    ...
    from virchow.utils.sensitive import make_mock_sensitive_value
    ...
    with patch(
        "ee.virchow.external_permissions.google_drive.doc_sync.GoogleDriveConnector",
    ...
    with patch(
        "ee.virchow.external_permissions.google_drive.group_sync.GoogleDriveConnector",
        return_value=_build_connector(google_drive_service_acct_connector_factory),
    ):
