...
# from virchow.tools.tool_implementations.images.image_generation_tool import (
...
#     ImageGenerationTool,
# )
# from virchow.tools.tool_implementations.images.image_generation_tool import ImageShape
