...
Tests the pass-through OAuth flow where Virchow forwards the user's login OAuth token
...
from virchow.db.enums import MCPAuthenticationPerformer
from virchow.db.enums import MCPAuthenticationType
from virchow.db.enums import MCPTransport
from virchow.db.mcp import create_mcp_server__no_commit
from virchow.db.models import OAuthAccount
from virchow.db.models import Persona
from virchow.db.models import Tool
...
from virchow.tools.tool_implementations.mcp.mcp_tool import MCPTool
...
class TestMCPPassThroughOAuth:
    ...
    def test_pt_oauth_passes_user_login_token(self, db_session: Session) -> None:
        ...
        This simulates a user who logged into Virchow with Google OAuth and is using
    ...
    def test_mcp_tool_run_sets_authorization_header_for_pt_oauth(
        ...
        with patch(
            "virchow.tools.tool_implementations.mcp.mcp_tool.call_mcp_tool",
