...
# from virchow.chat.turn.models import ChatTurnContext
# from virchow.configs.app_configs import CODE_INTERPRETER_BASE_URL
# from virchow.file_store.models import ChatFileType
# from virchow.file_store.models import InMemoryChatFile
# from virchow.file_store.utils import get_default_file_store
...
# from virchow.tools.tool_implementations_v2.code_interpreter_client import (
#     CodeInterpreterClient,
# )
# from virchow.tools.tool_implementations_v2.python import _python_execution_core
# from virchow.tools.tool_implementations_v2.python import python
# from virchow.tools.tool_implementations_v2.tool_result_models import (
...
#     with patch(
#         "virchow.tools.tool_implementations_v2.python.get_tool_by_name"
#     ) as mock_get_tool:
#         mock_tool = Mock()
#         mock_tool.id = 1
...
#         with patch(
#             "virchow.tools.tool_implementations_v2.python.CODE_INTERPRETER_DEFAULT_TIMEOUT_MS",
#             1000,
#         ):
#             # Execute code
...
#     with patch(
#         "virchow.tools.tool_implementations.python.python_tool.CODE_INTERPRETER_BASE_URL",
#         "http://localhost:8000",
#     ):
...
#     ) as mock_get_tool:
#         with patch(
#             "virchow.tools.tool_implementations_v2.python.CodeInterpreterClient"
...
#         with patch(
#             "virchow.tools.tool_implementations_v2.python.CODE_INTERPRETER_MAX_OUTPUT_LENGTH",
#             5000,
#         ):
#             mock_tool = Mock()
#             mock_tool.id = 1
...
import virchow.tools.tool_implementations.python.code_interpreter_client as ci_mod
...
from virchow.file_store.models import ChatFileType
from virchow.file_store.models import FileDescriptor
from virchow.server.features.projects.api import upload_user_files
from virchow.server.query_and_chat.chat_backend import get_chat_session
...
from virchow.server.query_and_chat.streaming_models import ToolCallArgumentDelta
from virchow.tools.tool_implementations.python.python_tool import PythonTool
...
def _clear_health_cache() -> None:
    ...
    import virchow.tools.tool_implementations.python.code_interpreter_client as mod
...
def test_code_interpreter_receives_chat_files(
    ...
    with (
        ...
        patch(
            "virchow.tools.tool_implementations.python.code_interpreter_client.CODE_INTERPRETER_BASE_URL",
            mock_url,
        ),
    ):
