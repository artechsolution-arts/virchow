...
from virchow.llm.model_response import ChatCompletionDeltaToolCall
from virchow.llm.model_response import Delta
from virchow.llm.model_response import FunctionCall
from virchow.llm.model_response import ModelResponse
from virchow.llm.model_response import ModelResponseStream
from virchow.llm.model_response import StreamingChoice
...
def use_mock_llm() -> Generator[MockLLMController, None, None]:
    ...
    with patch("virchow.chat.process_message.get_llm_for_persona", return_value=mock_llm):
        yield mock_llm
