...
from virchow.context.search.federated.slack_search import fetch_and_cache_channel_metadata
...
from virchow.db.models import LLMProvider
from virchow.db.models import Persona
from virchow.db.models import Persona__DocumentSet
from virchow.db.models import Persona__Tool
from virchow.db.models import SlackBot
from virchow.db.models import SlackChannelConfig
from virchow.db.models import User
from virchow.virchowbot.slack.listener import process_message
from virchow.virchowbot.slack.models import ChannelType
from virchow.db.tools import get_builtin_tool
from virchow.tools.built_in_tools import SearchTool
...
class TestSlackBotFederatedSearch:
    ...
    def _setup_slack_mocks(self, channel_name: str) -> tuple[list, list]:
        ...
        patches = [
            ...
            patch("virchow.context.search.federated.slack_search.query_slack"),
            patch("virchow.virchowbot.slack.listener.get_channel_type_from_id"),
            patch("virchow.context.search.utils.get_query_embeddings"),
        ]
    ...
    def _setup_query_slack_mock(
        ...
        from virchow.context.search.federated.slack_search import SlackQueryResult
    ...
    @patch("virchow.utils.gpu_utils.fast_gpu_status_request", return_value=False)
    @patch(
        "virchow.document_index.vespa.index.VespaIndex.hybrid_retrieval", return_value=[]
    )
...
@patch("virchow.context.search.federated.slack_search.get_redis_client")
@patch("virchow.context.search.federated.slack_search.WebClient")
...
def test_slack_channel_config_eager_loads_persona(db_session: Session) -> None:
    ...
    """
    from virchow.db.slack_channel_config import (
