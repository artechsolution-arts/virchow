...
from virchow.background.celery.tasks.user_file_processing.tasks import (
...
from virchow.db.models import Persona__UserFile
from virchow.db.models import User
from virchow.db.models import UserFile
from virchow.db.persona import upsert_persona
...
_PATCH_QUEUE_DEPTH = "virchow.background.celery.tasks.user_file_processing.tasks.get_user_file_project_sync_queue_depth"
...
_PATCH_GET_SETTINGS = (
    "virchow.background.celery.tasks.user_file_processing.tasks.get_active_search_settings"
)
_PATCH_GET_INDICES = (
    "virchow.background.celery.tasks.user_file_processing.tasks.get_all_document_indices"
)
_PATCH_HTTPX_INIT = (
    "virchow.background.celery.tasks.user_file_processing.tasks.httpx_init_vespa_pool"
)
_PATCH_DISABLE_VDB = (
    "virchow.background.celery.tasks.user_file_processing.tasks.DISABLE_VECTOR_DB"
)
...
class TestSyncTaskWritesPersonaIds:
    ...
    def test_passes_both_project_and_persona_ids(
        ...
        from virchow.db.models import Project__UserFile
        from virchow.db.models import UserProject
