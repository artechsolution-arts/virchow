...
from virchow.db.llm import fetch_auto_mode_providers
...
from virchow.llm.well_known_providers.auto_update_models import LLMProviderRecommendation
from virchow.llm.well_known_providers.auto_update_models import LLMRecommendations
from virchow.llm.well_known_providers.models import SimpleKnownModel
from virchow.server.manage.llm.api import put_llm_provider
...
class TestAutoModeSyncFeature:
    ...
    def test_auto_mode_syncs_models_from_github_config(
        ...
        try:
            with patch(
                "virchow.server.manage.llm.api.fetch_llm_recommendations_from_github",
