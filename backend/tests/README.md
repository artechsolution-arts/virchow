...
External services (Postgres, Redis, Vespa, OpenAI, etc.) are running, but Virchow
...
Full Virchow deployment running. No mocking. Prefer this over other test types when possible.
