...
from virchow.context.search.federated.slack_search_utils import (
    build_channel_query_filter,
)
from virchow.context.search.federated.slack_search_utils import matches_exclude_pattern
