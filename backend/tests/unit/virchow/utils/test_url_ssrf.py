...
from virchow.utils.url import _is_ip_private_or_reserved
from virchow.utils.url import _validate_and_resolve_url
from virchow.utils.url import ssrf_safe_get
from virchow.utils.url import SSRFException
from virchow.utils.url import validate_outbound_http_url
...
class TestValidateAndResolveUrl:
    ...
    def test_valid_http_scheme(self) -> None:
        ...
        with patch("virchow.utils.url.socket.getaddrinfo") as mock_getaddrinfo:
...
class TestSsrfSafeGet:
    ...
    def test_makes_request_to_validated_ip_http(self) -> None:
        ...
        with patch("virchow.utils.url.socket.getaddrinfo") as mock_getaddrinfo:
            ...
            with patch("virchow.utils.url.requests.get") as mock_get:
