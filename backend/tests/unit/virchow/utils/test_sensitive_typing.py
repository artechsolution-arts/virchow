...
Run with: mypy tests/unit/virchow/utils/test_sensitive_typing.py --ignore-missing-imports
...
def demonstrate_correct_usage() -> None:
    ...
    from virchow.utils.encryption import encrypt_string_to_bytes, decrypt_bytes_to_string
