...
from virchow.background.celery.tasks.hierarchyfetching.tasks import (
...
from virchow.connectors.interfaces import HierarchyOutput
from virchow.connectors.interfaces import SecondsSinceUnixEpoch

TASKS_MODULE = "virchow.background.celery.tasks.hierarchyfetching.tasks"
