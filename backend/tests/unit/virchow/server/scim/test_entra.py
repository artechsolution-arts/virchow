...
from ee.virchow.server.scim.api import create_user
from ee.virchow.server.scim.api import delete_user
from ee.virchow.server.scim.api import get_group
from ee.virchow.server.scim.api import get_resource_types
from ee.virchow.server.scim.api import get_schemas
from ee.virchow.server.scim.api import get_service_provider_config
from ee.virchow.server.scim.api import get_user
from ee.virchow.server.scim.api import list_groups
from ee.virchow.server.scim.api import list_users
from ee.virchow.server.scim.api import patch_group
from ee.virchow.server.scim.api import patch_user
from ee.virchow.server.scim.api import replace_user
from ee.virchow.server.scim.api import ScimJSONResponse
from ee.virchow.server.scim.models import SCIM_ENTERPRISE_USER_SCHEMA
from ee.virchow.server.scim.models import SCIM_USER_SCHEMA
from ee.virchow.server.scim.models import ScimEnterpriseExtension
from ee.virchow.server.scim.models import ScimGroupMember
from ee.virchow.server.scim.models import ScimGroupResource
from ee.virchow.server.scim.models import ScimManagerRef
from ee.virchow.server.scim.models import ScimMappingFields
from ee.virchow.server.scim.models import ScimName
from ee.virchow.server.scim.models import ScimPatchOperation
from ee.virchow.server.scim.models import ScimPatchOperationType
from ee.virchow.server.scim.models import ScimPatchRequest
from ee.virchow.server.scim.models import ScimPatchResourceValue
from ee.virchow.server.scim.models import ScimUserResource
from ee.virchow.server.scim.providers.base import ScimProvider
from ee.virchow.server.scim.providers.entra import EntraProvider
from tests.unit.virchow.server.scim.conftest import make_db_group
from tests.unit.virchow.server.scim.conftest import make_db_user
from tests.unit.virchow.server.scim.conftest import make_scim_user
from tests.unit.virchow.server.scim.conftest import make_user_mapping
from tests.unit.virchow.server.scim.conftest import parse_scim_group
from tests.unit.virchow.server.scim.conftest import parse_scim_list
from tests.unit.virchow.server.scim.conftest import parse_scim_user
...
class TestEntraUserLifecycle:
    ...
    @patch("ee.virchow.server.scim.api._check_seat_availability", return_value=None)
    ...
    def test_name_formatted_preserved_on_create(
        ...
        with patch(
            "ee.virchow.server.scim.api._check_seat_availability", return_value=None
        ):
            result = create_user(
                user_resource=resource,
                _token=mock_token,
...
class TestEntraGroupLifecycle:
    ...
    @patch("ee.virchow.server.scim.api.apply_group_patch")
