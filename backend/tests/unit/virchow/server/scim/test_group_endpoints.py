...
from ee.virchow.server.scim.api import create_group
from ee.virchow.server.scim.api import delete_group
...
from ee.virchow.server.scim.api import replace_group
...
from tests.unit.virchow.server.scim.conftest import make_scim_group
...
class TestCreateGroup:
    ...
    @patch("ee.virchow.server.scim.api._validate_and_parse_members")
    def test_success(
        self,
