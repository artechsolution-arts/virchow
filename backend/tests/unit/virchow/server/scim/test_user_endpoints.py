...
from ee.virchow.server.scim.api import _scim_name_to_str
...
from ee.virchow.server.scim.patch import ScimPatchError
from ee.virchow.server.scim.providers.base import ScimProvider
from tests.unit.virchow.server.scim.conftest import assert_scim_error
...
class TestCreateUser:
    ...
    @patch("ee.virchow.server.scim.api._check_seat_availability")
...
class TestPatchUser:
    ...
    @patch("ee.virchow.server.scim.api.apply_user_patch")
