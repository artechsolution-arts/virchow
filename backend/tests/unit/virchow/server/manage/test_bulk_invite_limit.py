...
from virchow.server.manage.users import bulk_invite_users


@patch("virchow.server.manage.users.MULTI_TENANT", True)
@patch("virchow.server.manage.users.is_tenant_on_trial_fn", return_value=True)
@patch("virchow.server.manage.users.get_current_tenant_id", return_value="test_tenant")
@patch("virchow.server.manage.users.get_invited_users", return_value=[])
@patch("virchow.server.manage.users.get_all_users", return_value=[])
@patch("virchow.server.manage.users.NUM_FREE_TRIAL_USER_INVITES", 5)
...
@patch("virchow.server.manage.users.MULTI_TENANT", True)
@patch("virchow.server.manage.users.DEV_MODE", True)
@patch("virchow.server.manage.users.ENABLE_EMAIL_INVITES", False)
@patch("virchow.server.manage.users.is_tenant_on_trial_fn", return_value=True)
@patch("virchow.server.manage.users.get_current_tenant_id", return_value="test_tenant")
@patch("virchow.server.manage.users.get_invited_users", return_value=[])
@patch("virchow.server.manage.users.get_all_users", return_value=[])
@patch("virchow.server.manage.users.write_invited_users", return_value=3)
@patch("virchow.server.manage.users.enforce_seat_limit")
@patch("virchow.server.manage.users.NUM_FREE_TRIAL_USER_INVITES", 5)
@patch(
    "virchow.server.manage.users.fetch_ee_implementation_or_noop",
...
_COMMON_PATCHES = [
    patch("virchow.server.manage.users.MULTI_TENANT", False),
    patch("virchow.server.manage.users.get_current_tenant_id", return_value="test_tenant"),
    patch("virchow.server.manage.users.get_invited_users", return_value=[]),
    patch("virchow.server.manage.users.get_all_users", return_value=[]),
    patch("virchow.server.manage.users.write_invited_users", return_value=1),
    patch("virchow.server.manage.users.enforce_seat_limit"),
]
...
@_with_common_patches
@patch("virchow.server.manage.users.ENABLE_EMAIL_INVITES", True)
@patch("virchow.server.manage.users.EMAIL_CONFIGURED", False)
...
@_with_common_patches
@patch("virchow.server.manage.users.ENABLE_EMAIL_INVITES", True)
@patch("virchow.server.manage.users.EMAIL_CONFIGURED", True)
@patch("virchow.server.manage.users.send_user_email_invite")
...
@patch("virchow.server.manage.users.EMAIL_CONFIGURED", True)
@patch(
    "virchow.server.manage.users.send_user_email_invite",
