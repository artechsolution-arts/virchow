...
from virchow.server.manage.embedding.api import list_embedding_models
from virchow.server.manage.embedding.api import list_embedding_providers
from virchow.utils.encryption import decrypt_bytes_to_string
from virchow.utils.encryption import encrypt_string_to_bytes
from virchow.utils.encryption import mask_string
from virchow.utils.sensitive import SensitiveValue
...
def test_list_embedding_models_masks_api_key() -> None:
    ...
    with patch(
        "virchow.server.manage.embedding.api.get_all_search_settings",
...
def test_list_embedding_providers_uses_sensitive_value_masking_once() -> None:
    ...
    with patch(
        "virchow.server.manage.embedding.api.fetch_existing_embedding_providers",
