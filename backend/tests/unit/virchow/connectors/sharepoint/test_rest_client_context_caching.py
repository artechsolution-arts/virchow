...
from virchow.connectors.sharepoint.connector import _REST_CTX_MAX_AGE_S
...
@patch("virchow.connectors.sharepoint.connector.acquire_token_for_rest")
@patch("virchow.connectors.sharepoint.connector.ClientContext")
...
@patch("virchow.connectors.sharepoint.connector.time")
@patch("virchow.connectors.sharepoint.connector.acquire_token_for_rest")
@patch("virchow.connectors.sharepoint.connector.ClientContext")
