...
from virchow.connectors.slab.connector import SlabConnector
...
@patch("virchow.connectors.slab.connector.get_all_post_ids", return_value=["id1"])
...
@patch(
    "virchow.connectors.slab.connector.get_all_post_ids",
