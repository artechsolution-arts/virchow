...
from virchow.connectors.factory import _connector_cache
from virchow.connectors.factory import _load_connector_class
...
from virchow.connectors.registry import ConnectorMapping
...
class TestConnectorClassLoading:
    ...
    def test_load_connector_class_import_error(self, mock_import: Mock) -> None:
        ...
        assert (
            "Failed to import WebConnector from virchow.connectors.web.connector"
    ...
    def test_mapping_format_consistency(self) -> None:
        ...
        for source, mapping in CONNECTOR_CLASS_MAP.items():
            ...
            assert mapping.module_path.startswith(
                "virchow.connectors."
            ), f"{source.value} module_path doesn't start with virchow.connectors."
