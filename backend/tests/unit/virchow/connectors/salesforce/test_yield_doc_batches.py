...
from virchow.connectors.salesforce.connector import _convert_to_metadata_value
from virchow.connectors.salesforce.connector import SalesforceConnector
...
class TestYieldDocBatches:
    ...
    def mock_sf_db(self) -> MagicMock:
        """Create a mock VirchowSalesforceSQLite object."""
        return MagicMock()
    ...
    @patch("virchow.connectors.salesforce.connector.convert_sf_object_to_doc")
