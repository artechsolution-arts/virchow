...
from virchow.connectors.cross_connector_utils.miscellaneous_utils import time_str_to_utc
...
from virchow.connectors.salesforce.doc_conversion import _extract_section
...
from virchow.connectors.salesforce.salesforce_calls import _bulk_retrieve_from_salesforce
from virchow.connectors.salesforce.salesforce_calls import _make_time_filter_for_sf_type
from virchow.connectors.salesforce.salesforce_calls import _make_time_filtered_query
from virchow.connectors.salesforce.salesforce_calls import get_object_by_id_query
...
# from virchow.connectors.salesforce.virchow_salesforce_type import VirchowSalesforceType
# from virchow.connectors.salesforce.salesforce_calls import get_children_of_sf_type
...
def _create_csv_with_example_data(sf_db: VirchowSalesforceSQLite) -> None:
    """
...
def _test_query(sf_db: VirchowSalesforceSQLite) -> None:
    """
...
def _test_upsert(sf_db: VirchowSalesforceSQLite) -> None:
    """
...
def _test_relationships(sf_db: VirchowSalesforceSQLite) -> None:
    """
...
def _test_account_with_children(sf_db: VirchowSalesforceSQLite) -> None:
    """
...
def _test_relationship_updates(sf_db: VirchowSalesforceSQLite) -> None:
    """
...
def _test_get_affected_parent_ids(sf_db: VirchowSalesforceSQLite) -> None:
    """
...
def test_salesforce_sqlite() -> None:
    with tempfile.TemporaryDirectory() as directory:
        ...
        sf_db = VirchowSalesforceSQLite(filename)
        sf_db.connect()
        sf_db.apply_schema()
...
def test_salesforce_bulk_retrieve() -> None:
    ...
    # virchow_sf_type = VirchowSalesforceType("Contact", sf_client)
...
def test_normalize_record() -> None:
    ...
    with open(current_dir / "test_account.csv", "r", newline="", encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            normalized_record, parent_ids = VirchowSalesforceSQLite.normalize_record(row)
...
def test_salesforce_connector_single() -> None:
    ...
    # virchow_parent_sf_type = VirchowSalesforceType(parent_type, sf_client)
    ...
    normalized_record, _ = VirchowSalesforceSQLite.normalize_record(record)
