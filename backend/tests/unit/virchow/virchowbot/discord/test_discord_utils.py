...
class TestGetBotToken:
    ...
    def test_get_token_from_env(self) -> None:
        ...
        with patch("virchow.virchowbot.discord.utils.DISCORD_BOT_TOKEN", "env_token_123"):
    ...
    def test_get_token_from_db(self) -> None:
        ...
        with (
            patch("virchow.virchowbot.discord.utils.DISCORD_BOT_TOKEN", None),
            patch("virchow.virchowbot.discord.utils.AUTH_TYPE", "basic"),  # Not CLOUD
            patch("virchow.virchowbot.discord.utils.get_session_with_tenant") as mock_session,
            patch(
                "virchow.virchowbot.discord.utils.get_discord_bot_config",
    ...
    def test_get_token_env_priority(self) -> None:
        ...
        with (
            patch("virchow.virchowbot.discord.utils.DISCORD_BOT_TOKEN", "env_token_123"),
            patch(
                "virchow.virchowbot.discord.utils.get_discord_bot_config",
                return_value=mock_config,
            ),
