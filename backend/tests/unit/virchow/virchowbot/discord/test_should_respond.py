...
from virchow.virchowbot.discord.handle_message import check_implicit_invocation
...
class TestBasicShouldRespond:
    ...
    async def test_should_respond_guild_disabled(
        ...
        with patch(
            "virchow.virchowbot.discord.handle_message.get_session_with_tenant"
        ) as mock_session:
            mock_db = MagicMock()
            ...
            with patch(
                "virchow.virchowbot.discord.handle_message.get_guild_config_by_discord_id",
    ...
    async def test_should_respond_guild_enabled(
        ...
        with patch(
            ...
            with (
                ...
                patch(
                    "virchow.virchowbot.discord.handle_message.get_channel_config_by_discord_ids",
    ...
    async def test_should_respond_require_mention_true_no_mention(
        ...
        with patch(
            ...
            with (
                ...
                patch(
                    "virchow.virchowbot.discord.handle_message.check_implicit_invocation",
                    return_value=False,
                ),
            ):
                result = await should_respond(
