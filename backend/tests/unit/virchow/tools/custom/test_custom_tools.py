...
from virchow.tools.tool_implementations.custom.custom_tool import CustomToolCallSummary
from virchow.tools.tool_implementations.custom.custom_tool import (
...
class TestCustomTool(unittest.TestCase):
    ...
    @patch("virchow.tools.tool_implementations.custom.custom_tool.requests.request")
