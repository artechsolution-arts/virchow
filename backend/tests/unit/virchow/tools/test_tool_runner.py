...
from virchow.tools.tool_runner import _extract_image_file_ids_from_tool_response_message
from virchow.tools.tool_runner import _extract_recent_generated_image_file_ids
from virchow.tools.tool_runner import _merge_tool_calls
