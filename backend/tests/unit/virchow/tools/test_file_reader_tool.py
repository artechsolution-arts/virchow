...
from virchow.tools.tool_implementations.file_reader.file_reader_tool import FILE_ID_FIELD
from virchow.tools.tool_implementations.file_reader.file_reader_tool import FileReaderTool
from virchow.tools.tool_implementations.file_reader.file_reader_tool import MAX_NUM_CHARS
from virchow.tools.tool_implementations.file_reader.file_reader_tool import NUM_CHARS_FIELD
from virchow.tools.tool_implementations.file_reader.file_reader_tool import (
    START_CHAR_FIELD,
)

TOOL_MODULE = "virchow.tools.tool_implementations.file_reader.file_reader_tool"
