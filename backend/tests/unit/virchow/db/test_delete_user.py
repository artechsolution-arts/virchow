...
from virchow.db.models import DocumentSet__User
from virchow.db.models import Persona
from virchow.db.models import Persona__User
from virchow.db.models import SamlAccount
...
@patch("virchow.db.users.remove_user_from_invited_users")
@patch(
    "virchow.db.users.fetch_ee_implementation_or_noop",
