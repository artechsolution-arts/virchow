...
from virchow.chat.compression import _build_llm_messages_for_summarization
from virchow.chat.compression import find_summary_for_branch
from virchow.chat.compression import generate_summary
from virchow.chat.compression import get_compression_params
from virchow.chat.compression import get_messages_to_summarize
from virchow.chat.compression import SummaryContent
...
from virchow.prompts.compression_prompts import PROGRESSIVE_SUMMARY_SYSTEM_PROMPT_BLOCK
from virchow.prompts.compression_prompts import PROGRESSIVE_USER_REMINDER
from virchow.prompts.compression_prompts import SUMMARIZATION_CUTOFF_MARKER
from virchow.prompts.compression_prompts import SUMMARIZATION_PROMPT
from virchow.prompts.compression_prompts import USER_REMINDER
...
def test_generate_summary_initial_system_prompt() -> None:
    ...
    with patch("virchow.chat.compression.llm_generation_span"):
