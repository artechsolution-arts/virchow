...
from virchow.chat.process_message import determine_search_params
from virchow.chat.process_message import extract_context_files
from virchow.chat.process_message import resolve_context_user_files
...
class TestResolveContextUserFiles:
    ...
    @patch("virchow.chat.process_message.get_user_files_from_project")
...
class TestExtractContextFiles:
    ...
    @patch("virchow.chat.process_message.load_in_memory_chat_files")
    ...
    @patch("virchow.chat.process_message.DISABLE_VECTOR_DB", True)
