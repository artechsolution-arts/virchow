...
from virchow.chat.llm_step import _extract_tool_call_kickoffs
from virchow.chat.llm_step import _increment_turns
from virchow.chat.llm_step import _parse_tool_args_to_dict
from virchow.chat.llm_step import _resolve_tool_arguments
from virchow.chat.llm_step import _XmlToolCallContentFilter
...
<parameter name="queries" string="false">["Virchow documentation", "Virchow docs", "Virchow platform"]</parameter>
</invoke>
</function_calls>
"""
        tool_calls = extract_tool_calls_from_response_text(
...
<parameter name="queries" string="false">["Virchow docs"]</parameter>
</invoke>
</function_calls>
"""
        tool_calls = extract_tool_calls_from_response_text(
...
class TestXmlToolCallContentFilter:
    ...
    def test_strips_function_calls_block_split_across_chunks(self) -> None:
        ...
        chunks = [
            ...
            '<parameter name="queries" string="false">["Virchow docs"]',
