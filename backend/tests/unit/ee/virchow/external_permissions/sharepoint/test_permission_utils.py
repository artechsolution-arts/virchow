...
from ee.virchow.external_permissions.sharepoint.permission_utils import (
...
from ee.virchow.external_permissions.sharepoint.permission_utils import GroupsResult


MODULE = "ee.virchow.external_permissions.sharepoint.permission_utils"
