...
from ee.virchow.db.license import check_seat_availability
from ee.virchow.db.license import delete_license
from ee.virchow.db.license import get_license
from ee.virchow.db.license import upsert_license
from ee.virchow.server.license.models import LicenseMetadata
from ee.virchow.server.license.models import LicenseSource
from ee.virchow.server.license.models import PlanType
from virchow.db.models import License
from virchow.server.settings.models import ApplicationStatus
...
class TestCheckSeatAvailabilitySelfHosted:
    ...
    @patch("ee.virchow.db.license.get_license_metadata", return_value=None)
    ...
    @patch("ee.virchow.db.license.get_used_seats", return_value=5)
    @patch("ee.virchow.db.license.get_license_metadata")
    ...
    @patch("ee.virchow.db.license.get_used_seats", return_value=10)
    @patch("ee.virchow.db.license.get_license_metadata")
    ...
    @patch("ee.virchow.db.license.get_used_seats", return_value=9)
    @patch("ee.virchow.db.license.get_license_metadata")
...
class TestCheckSeatAvailabilityMultiTenant:
    ...
    @patch("ee.virchow.db.license.MULTI_TENANT", True)
    @patch(
        "ee.virchow.server.tenants.user_mapping.get_tenant_count",
        return_value=5,
    )
    @patch("ee.virchow.db.license.get_license_metadata")
