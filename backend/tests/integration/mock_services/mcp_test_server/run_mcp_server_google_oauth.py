...
Virchow. When users log into Virchow with Google OAuth, their access token is stored
...
class GoogleOAuthTokenVerifier(TokenVerifier):
    ...
    This is useful for testing pass-through OAuth scenarios where Virchow
...
if __name__ == "__main__":
    ...
    app = FastAPI(
        ...
        description="MCP server that authenticates using Google OAuth tokens passed through from Virchow",
    ...
    def info() -> dict[str, Any]:
        return {
            ...
            "description": "Validates Google OAuth tokens passed from Virchow",
