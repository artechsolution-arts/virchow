...
class TestVirchowWebCrawler:
    """
    Integration tests for the Virchow web crawler functionality.
    ...
    def test_fetches_public_url_successfully(self, admin_user: DATestUser) -> None:
        ...
        assert data["provider_type"] == WebContentProviderType.VIRCHOW_WEB_CRAWLER.value
...
def test_web_search_endpoints_with_exa(
    ...
    assert open_data["provider_type"] == WebContentProviderType.VIRCHOW_WEB_CRAWLER.value
    ...
    assert (
        ...
        == WebContentProviderType.VIRCHOW_WEB_CRAWLER.value
    )
