...
# NOTE: the tests for client should be independent of the Virchow MCP server
# This means the port should probably stay to be 8010/not 8090 the Virchow MCP server port
# Use MOCK_MCP_SERVER_PORT to avoid conflicts with the real Virchow MCP server port (8090)
