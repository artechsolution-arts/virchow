...
from virchow.connectors.mock_connector.connector import EXTERNAL_USER_EMAILS
from virchow.connectors.mock_connector.connector import EXTERNAL_USER_GROUP_IDS
from virchow.connectors.mock_connector.connector import MockConnectorCheckpoint
