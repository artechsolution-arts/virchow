...
from virchow.db.engine.sql_engine import build_connection_string
...
from virchow.db.engine.sql_engine import SYNC_DB_API
...
from virchow.document_index.vespa.index import DOCUMENT_ID_ENDPOINT
...
def reset_postgres_multitenant() -> None:
    ...
    reset_postgres(config_name="schema_private", setup_virchow=False)
