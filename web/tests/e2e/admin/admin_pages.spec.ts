...
const ADMIN_PAGES: AdminPageSnapshot[] = [
  ...
  },
  {
    ...
    options: {
      paragraphText:
        "Document Sets allow you to group logically connected documents into a single bundle. These can then be used as a filter when performing searches to control the scope of information Virchow searches over.",
    },
  },
  {
    ...
    options: {
      paragraphText:
        "Setup Slack bots that connect to Virchow. Once setup, you will be able to ask questions to Virchow directly from Slack. Additionally, you can:",
    },
  },
  {
