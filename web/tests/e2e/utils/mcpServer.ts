 ...
 *
 * This server validates Google OAuth tokens that are passed through from Virchow.
 * It calls Google's tokeninfo endpoint to verify the token is valid.
 *
 * For testing pass-through OAuth scenarios where Virchow forwards the user's
