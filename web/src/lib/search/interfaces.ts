...
export interface MinimalVirchowDocument {
  document_id: string;
  semantic_identifier: string | null;
}

export interface VirchowDocument extends MinimalVirchowDocument {
  link: string;
  source_type: ValidSources;
  blurb: string;
  boost: number;
...
export interface LoadedVirchowDocument extends VirchowDocument {
  icon: React.FC<{ size?: number; className?: string }>;
}

export interface SearchVirchowDocument extends VirchowDocument {
  is_relevant: boolean;
  relevance_explanation: string;
}

export interface FilteredVirchowDocument extends VirchowDocument {
  included: boolean;
}
...
export interface SearchResponse {
  ...
  answer: string | null;
  quotes: Quote[] | null;
  documents: SearchVirchowDocument[] | null;
...
export interface SearchRequestArgs {
  ...
  updateDocs: (documents: VirchowDocument[]) => void;
 ...
 * Matches backend/virchow/context/search/models.py BaseFilters
 */
