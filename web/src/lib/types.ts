...
interface UserPreferences {
  // TODO: rename to agent — https://linear.app/virchow-app/issue/ENG-3766
...
export function federatedSourceToRegularSource(source: string | null | undefined): ValidSources {
  if (!source) {
    return ValidSources.NotApplicable;
  }
  if (source.startsWith("federated_")) {
    return source.replace("federated_", "") as ValidSources;
  }
  return source as ValidSources;
}
