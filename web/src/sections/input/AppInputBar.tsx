...
export interface AppInputBarProps {
  ...
  setPresentingDocument?: (document: MinimalVirchowDocument) => void;
...
const AppInputBar = React.memo(
  ({
    ...
    const isVoicePlaybackActive = false;
    const isVoicePlaybackControllable = false;
    const isTTSActuallySpeaking = false;
    ...
    // Convert ProjectFile to MinimalVirchowDocument format for viewing
    const handleFileClick = useCallback(
      (file: ProjectFile) => {
        if (!setPresentingDocument) return;

        const documentForViewer: MinimalVirchowDocument = {
    ...
    const chatControls = (
      ...
      >
        ...
        <div className="flex flex-row items-center gap-1">
          ...
          >
            <Button
              id="virchow-chat-input-send-button"
              icon={
                isClassifying
                  ? SimpleLoader
                  : chatState === "streaming"
      ...
      <Disabled disabled={disabled} allowClick>
        ...
        >
          ...
          <div className="flex flex-row items-center w-full">
            <Popover
              open={
                hasMounted && user?.preferences?.shortcut_enabled && showPrompts
              }
            ...
            >
              <Popover.Anchor asChild>
                ...
                >
                  <textarea
                    id="virchow-chat-input-textarea"
                    role="textarea"
                    ref={textAreaRef}
                    onPaste={handlePaste}
