...
import { MinimalVirchowDocument, VirchowDocument } from "@/lib/search/interfaces";
...
// Build an VirchowDocument from basic file info
const buildVirchowDocumentFromFile = (
  id: string,
  name?: string | null,
...
interface DocumentsSidebarProps {
  closeSidebar: () => void;
  selectedDocuments: VirchowDocument[] | null;
  modal: boolean;
  setPresentingDocument: Dispatch<SetStateAction<MinimalVirchowDocument | null>>;
}
              ...
              <ChatDocumentDisplayWrapper>
                {humanFileDescriptors.map((file) => (
                  <ChatDocumentDisplay
                    ...
                    setPresentingDocument={setPresentingDocument}
                    modal={modal}
                    document={buildVirchowDocumentFromFile(
                      file.id,
                      file.name,
                      false
                    )}
