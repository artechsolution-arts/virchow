...
export const Default: Story = {
  args: {
    href: "https://docs.virchow.app",
    children: "Virchow Documentation",
  },
};

export const CustomClassName: Story = {
  args: {
    href: "https://github.com/virchow-dot-app/virchow",
...
export const InContext: Story = {
  render: () => (
    <p className="font-main-content-body text-text-04">
      ...
      <InlineExternalLink href="https://docs.virchow.app">
        official documentation
      </InlineExternalLink>{" "}
      or check out the{" "}
      <InlineExternalLink href="https://github.com/virchow-dot-app/virchow">
        source code
      </InlineExternalLink>
      .
    </p>
