...
export type VirchowColumnKind = "qualifier" | "data" | "display" | "actions";

// ---------------------------------------------------------------------------
// Column definitions (discriminated union on `kind`)
// ---------------------------------------------------------------------------

interface VirchowColumnBase<TData> {
  kind: VirchowColumnKind;
...
export interface VirchowQualifierColumn<TData> extends VirchowColumnBase<TData> {
  kind: "qualifier";
...
export interface VirchowDataColumn<TData> extends VirchowColumnBase<TData> {
  kind: "data";
...
export interface VirchowDisplayColumn<TData> extends VirchowColumnBase<TData> {
  kind: "display";
}

/** Actions column — fixed column with visibility/sorting popovers. */
export interface VirchowActionsColumn<TData> extends VirchowColumnBase<TData> {
  kind: "actions";
...
export type VirchowColumnDef<TData> =
  | VirchowQualifierColumn<TData>
  | VirchowDataColumn<TData>
  | VirchowDisplayColumn<TData>
  | VirchowActionsColumn<TData>;
...
export interface DataTableProps<TData> {
  ...
  columns: VirchowColumnDef<TData>[];
