...
import type {
  ...
  VirchowColumnDef,
  VirchowDataColumn,
  VirchowQualifierColumn,
  VirchowActionsColumn,
...
interface ProcessedColumns<TData> {
  ...
  qualifierColumn: VirchowQualifierColumn<TData> | null;
  /** Map from column ID → VirchowColumnDef for dispatch in render loops. */
  columnKindMap: Map<string, VirchowColumnDef<TData>>;
}
...
function processColumns<TData>(
  ...
  const columnKindMap = new Map<string, VirchowColumnDef<TData>>();
  let qualifierColumn: VirchowQualifierColumn<TData> | null = null;
                ...
                <TableRow key={headerGroup.id}>
                  {headerGroup.headers.map((header, headerIndex) => {
                    ...
                    if (colDef?.kind === "actions") {
                      const actionsDef = colDef as VirchowActionsColumn<TData>;
                      return (
                    ...
                    const dataCol =
                      colDef?.kind === "data"
                        ? (colDef as VirchowDataColumn<TData>)
                        : null;
                    ...
                    return (
                      <TableHead
                        ...
                        sorted={
                          canSort ? toVirchowSortDirection(sortDir) : undefined
                        }
                        onSort={
                          canSort
                  ...
                  >
                    {row.getVisibleCells().map((cell) => {
                      ...
                      if (cellColDef?.kind === "qualifier") {
                        const qDef = cellColDef as VirchowQualifierColumn<TData>;
                        return (
                          <QualifierContainer
                            key={cell.id}
                            type="cell"
