...
interface TableColumnsBuilder<TData> {
  ...
  qualifier(config?: QualifierConfig<TData>): VirchowQualifierColumn<TData>;
  ...
  displayColumn(config: DisplayColumnConfig<TData>): VirchowDisplayColumn<TData>;

  /** Create an actions column (visibility/sorting popovers). */
  actions(config?: ActionsConfig<TData>): VirchowActionsColumn<TData>;
}
