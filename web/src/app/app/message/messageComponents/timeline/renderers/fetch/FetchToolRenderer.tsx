...
const documentToSourceInfo = (doc: VirchowDocument): SourceInfo => ({
  id: doc.document_id,
          ...
          <div className="flex flex-col">
            ...
            {displayDocuments ? (
              <SearchChipList
                ...
                getKey={(doc: VirchowDocument) => doc.document_id}
                toSourceInfo={(doc: VirchowDocument) => documentToSourceInfo(doc)}
                onClick={(doc: VirchowDocument) => {
