...
export interface SearchSession {
  ...
  documents: SearchVirchowDocument[];
...
export interface Message {
  ...
  message: string;
  type: "user" | "assistant" | "system" | "error"; // TODO: rename "assistant" to "agent" — https://linear.app/virchow-app/issue/ENG-3766
  ...
  documents?: VirchowDocument[] | null;
...
export interface BackendMessage {
  ...
  context_docs: VirchowDocument[] | null;
  time_sent: string;
  overridden_model: string;
  alternate_assistant_id: number | null; // TODO: rename to agent — https://linear.app/virchow-app/issue/ENG-3766
  chat_session_id: string;
...
export interface MessageResponseIDInfo {
  ...
  reserved_assistant_message_id: number; // TODO: rename to agent — https://linear.app/virchow-app/issue/ENG-3766
}
...
export interface SubQuestionDetail extends BaseQuestionIdentifier {
  ...
  context_docs?: { top_documents: VirchowDocument[] } | null;
  is_complete?: boolean;
  is_stopped?: boolean;
