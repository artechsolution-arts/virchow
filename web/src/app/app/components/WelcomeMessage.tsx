...
import { VirchowLogoTypeIcon } from "@/components/icons/icons";
import {
  getRandomGreeting,
  GREETING_MESSAGES,
...
export default function WelcomeMessage({
  ...
  if (isDefaultAgent) {
    content = (
      <div data-testid="virchow-logo" className="flex flex-row items-center gap-4">
        <VirchowLogoTypeIcon size={100} className="flex-shrink-0" />
        <Text as="p" headingH2>
          {greeting}
        </Text>
      </div>
