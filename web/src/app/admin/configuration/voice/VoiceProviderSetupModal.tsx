...
import { SvgArrowExchange, SvgVirchowLogo } from "@opal/icons";
  ...
  const LogoArrangement: FunctionComponent<IconProps> = () => (
    <div className="flex items-center gap-2">
      ...
      <div className="flex items-center justify-center size-7 p-0.5 shrink-0 overflow-clip">
        <SvgVirchowLogo size={24} className="text-text-04 shrink-0" />
      </div>
    </div>
  );
        ...
        <Modal.Body>
          <Section gap={1} alignItems="stretch">
              ...
              <Vertical
                ...
                subDescription={
                  <>
                    ...
                    . Virchow extracts the speech region from this URL. Examples:
            ...
            {providerType === "openai" && mode === "tts" && (
              <Vertical
                title="Default Model"
                subDescription="This model will be used by Virchow by default for text-to-speech."
                nonInteractive
              >
