...
const BILLING_HELP_URL = "https://docs.virchow.app/more/billing";
  ...
  return (
    <Card padding={0} alignItems="stretch" gap={0}>
      ...
      <Section flexDirection="column" alignItems="stretch" gap={0} padding={1}>
        ...
        <Text secondaryBody text03>
          Manually add and activate a license for this Virchow instance.
        </Text>
      </Section>
        ...
        >
          ...
          <InputLayouts.Vertical
            ...
            subDescription={
              error
                ? undefined
                : "Paste or attach your license key file you received from Virchow."
            }
          >
            <InputFile
