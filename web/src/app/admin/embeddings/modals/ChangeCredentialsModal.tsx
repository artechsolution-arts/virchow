    ...
    <Modal open onOpenChange={onCancel}>
      <Modal.Content>
        <Modal.Header
          ...
          )} ${isProxy || isOllama ? "Configuration" : "key"}`}
          onClose={onCancel}
        />
        <Modal.Body>
          {!isAzure && (
            <>
              ...
              <div className="flex flex-col gap-2">
                ...
                {(isProxy || isOllama) && (
                  <>
                    ...
                    <div>
                      ...
                      <Text as="p">
                        Since you are using {isOllama ? "Ollama" : "a liteLLM proxy"}, we&apos;ll need a
                ...
                <Button
                  ...
                  disabled={isOllama ? !apiUrl || !modelName : !apiKey}
                >
