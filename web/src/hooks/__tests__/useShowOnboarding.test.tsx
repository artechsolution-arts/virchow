...
describe("useShowOnboarding", () => {
  ...
  describe("localStorage persistence", () => {
    it("finishOnboarding sets localStorage flag and onboardingDismissed", () => {
      ...
      expect(localStorage.getItem("virchow:onboardingCompleted:user-1")).toBe(
        "true"
      );
    });
    ...
    it("showOnboarding stays false when localStorage flag is set", () => {
      localStorage.setItem("virchow:onboardingCompleted:user-1", "true");
    ...
    it("dismissal for user-1 does not suppress onboarding for user-2", () => {
      ...
      expect(localStorage.getItem("virchow:onboardingCompleted:1")).toBe("true");
      ...
      expect(localStorage.getItem("virchow:onboardingCompleted:2")).toBeNull();
    });
  });
});
