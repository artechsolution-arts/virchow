...
A living catalog for browsing, testing, and documenting Virchow UI components in isolation.

---

## What is this?

This Storybook contains interactive examples of every reusable UI component in the Virchow frontend. Each component has a dedicated page with:
...
Production builds deploy to [virchow-storybook.vercel.app](https://virchow-storybook.vercel.app) automatically when PRs touching component files merge to `main`.
