/**
 * Virchow Chat Widget - Main Component
...
@customElement("virchow-chat-widget")
export class VirchowChatWidget extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    "virchow-chat-widget": VirchowChatWidget;
  }
}
