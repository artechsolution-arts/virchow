...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function handleFinish() {
    const domain = domainInput.value.trim() || DEFAULT_VIRCHOW_DOMAIN;
    const useVirchowAsDefault = useVirchowAsDefaultToggle.checked;
    ...
    chrome.storage.local.get(
      {
        ...
        [CHROME_SPECIFIC_STORAGE_KEYS.USE_VIRCHOW_AS_DEFAULT_NEW_TAB]: true,
      },
      (result) => {
        if (result[CHROME_SPECIFIC_STORAGE_KEYS.VIRCHOW_DOMAIN]) {
