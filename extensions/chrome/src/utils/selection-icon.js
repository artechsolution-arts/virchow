(function () {
  ...
  function createSelectionIcon() {
    ...
    selectionIcon.id = "virchow-selection-icon";

    const img = document.createElement("img");
    img.src = chrome.runtime.getURL("public/icon32.png");
    img.alt = "Search with Virchow";
  ...
  document.addEventListener("mouseup", (e) => {
    if (
      e.target.id === "virchow-selection-icon" ||
      e.target.closest("#virchow-selection-icon")
    ) {
      return;
    }
