...
variable "BACKEND_REPOSITORY" {
  default = "virchowdotapp/virchow-backend"
}

variable "WEB_SERVER_REPOSITORY" {
  default = "virchowdotapp/virchow-web-server"
}

variable "MODEL_SERVER_REPOSITORY" {
  default = "virchowdotapp/virchow-model-server"
}

variable "INTEGRATION_REPOSITORY" {
  default = "virchowdotapp/virchow-integration"
}

variable "CLI_REPOSITORY" {
  default = "virchowdotapp/virchow-cli"
}
