...
import (
	...
	"github.com/virchow-dot-app/virchow/tools/ods/internal/lazyimports"
)
...
Examples:
  ...
  ods check-lazy-imports virchow/llm/           # Check only files in virchow/llm/
  ods check-lazy-imports virchow/chat/chat.py   # Check a specific file`,
