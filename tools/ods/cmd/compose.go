...
const composeProjectName = "virchow"
...
func NewComposeCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "compose [profile]",
		Short: "Launch Virchow docker containers",
		Long: `Launch Virchow docker containers using docker compose.
...
// compose project by running "docker compose -p virchow ps --services".
