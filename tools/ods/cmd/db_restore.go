...
import (
	...
	"github.com/virchow-dot-app/virchow/tools/ods/internal/docker"
	"github.com/virchow-dot-app/virchow/tools/ods/internal/paths"
	"github.com/virchow-dot-app/virchow/tools/ods/internal/postgres"
	"github.com/virchow-dot-app/virchow/tools/ods/internal/prompt"
	"github.com/virchow-dot-app/virchow/tools/ods/internal/s3"
)

const seededSnapshotURL = "s3://virchow-internal-tools/seeded.dump"
...
in the default snapshots directory (~/.local/share/virchow-dev/snapshots/).
...
func runDBRestore(input string, opts *DBRestoreOptions) {
	...
	containerTmpFile := "/tmp/virchow_restore_tmp"
