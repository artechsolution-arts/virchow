...
import (
	...
	"github.com/virchow-dot-app/virchow/tools/ods/internal/imgdiff"
...
const (
	...
	DefaultS3Bucket = "virchow-playwright-artifacts"
...
The bucket defaults to "virchow-playwright-artifacts" and can be overridden
...
Examples:
  ...
  ods screenshot-diff upload-baselines \
    --dir ./web/output/screenshots/ \
    --dest s3://virchow-playwright-artifacts/baselines/admin/main/`,
		Run: func(cmd *cobra.Command, args []string) {
