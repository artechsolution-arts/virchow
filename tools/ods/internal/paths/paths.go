...
// DataDir returns the data directory for virchow-dev tools.
// On Linux/macOS: ~/.local/share/virchow-dev/
// On Windows: %LOCALAPPDATA%/virchow-dev/
func DataDir() string {
	var base string
	...
	return filepath.Join(base, "virchow-dev")
}
