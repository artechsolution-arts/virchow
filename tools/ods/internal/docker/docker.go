...
var postgresContainerNames = []string{
	"virchow_postgres",                  // From restart_containers.sh
	"virchow-relational_db-1",           // Docker compose default project name
	"virchow-stack-relational_db-1",     // Docker compose with stack project name
