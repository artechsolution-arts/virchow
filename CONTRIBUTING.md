# Contributing to Virchow
Hey there! We are so excited that you're interested in Virchow.


## Contribution Opportunities
The [GitHub Issues](https://github.com/virchow-dot-app/virchow/issues) page is a great place to look for and share contribution ideas.
...
## Release Process
Virchow loosely follows the SemVer versioning standard.
Major changes are released with a "minor" version bump. Currently we use patch release versions to indicate small feature changes.
A set of Docker containers will be pushed automatically to DockerHub with every tag.
You can see the containers [here](https://hub.docker.com/search?q=virchow%2F).
